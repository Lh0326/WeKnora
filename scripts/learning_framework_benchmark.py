...
Protocol and schema audit live in docs/evaluation/response-prediction. Raw records
...
PROTOCOL = ROOT / "docs/evaluation/response-prediction/evaluation-protocol.json"
SCHEMA = ROOT / "docs/evaluation/response-prediction/schema-audit.md"
