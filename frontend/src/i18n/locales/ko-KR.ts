export default {
  ...
  knowledgeEditor: {
    learningTab: {
      tabLearning: '학습',
      title: '지식 네트워크 진도',
      litOf: '{total}개 중 {lit}개 노드 점등',
      noNodes: '지식 네트워크가 아직 생성되지 않았습니다 — 먼저 그래프에서 페이지를 만들어 보세요',
      unitsTitle: '폴더별 진도',
      rootUnit: '루트',
      masteredOf: '{n}개 마스터됨',
      practiceN: '연습 · {n}문제',
      levelKeep: '현재 등급: {level} · 유효 숙련도 {p}%',
      levelUpdate: '숙련도: {from} → {to}',
      optedOutNote: '수집 중지됨: 이번 답안은 기록되지 않고 숙련도도 변하지 않습니다',
      collectOnNote: '수집 중지됨: 질문과 퀴즈가 더 이상 학습 기록을 만들지 않습니다',
      ...
      tlToday: '오늘',
      tlYesterday: '어제',
      reAskHint: '이 노드를 아직 완전히 이해하지 못했을 수 있습니다: 위키 페이지를 읽거나 퀴즈를 풀어 확인해 보세요',
      ...
      tierUnseen: '미접촉',
      tierFaded: "약해짐",
      explainTitle: "이 등급인 이유?",
      explainPEff: "유효 숙련도 {p}% (시간 감쇠 반영)",
      explainThresholds: "점등 ≥30%, 친숙 ≥55%, 숙달 ≥80%",
      explainEvidence: "학습 증거: 긍정 {pos}개 · 부정 {neg}개",
      explainFaded: "학습한 적이 있지만 오답과 반복 재질문으로 점수가 낮아지고 시간이 지나 감쇠하여 점등선 아래로 떨어졌습니다 — 퀴즈를 맞히면 빠르게 회복됩니다",
      explainImprove: "향상 방법: 퀴즈 정답 +2.2 · 다음 날 다시 읽기 +0.5 · 다른 질문에서 재방문 +1.6",
      tierTouched: '접촉함',
      tierFamiliar: '익숙함',
      tierMastered: '숙달함',
      tierHintUnseen: '아직 학습 증거 없음',
      tierHintTouched: '유효 숙달도 ≥ 30% (점등으로 간주)',
      tierHintFamiliar: '유효 숙달도 ≥ 55%, 퀴즈 정답 필요',
      tierHintMastered: '유효 숙달도 ≥ 80%, 다른 날 서로 다른 퀴즈 2문항 정답 필요',
      howComputedTitle: '진도 계산 방법',
      howComputedSignals: '답변 인용, 페이지 읽기, 퀴즈 응시가 모두 해당 노드에 숙련 증거를 누적합니다: 답변 인용 +1.0, 페이지 읽기 +0.5(열 때마다 타임라인에 기록, 점수는 48시간 1회), 다른 질문에서 재방문 +1.6, 퀴즈 정답 +2.2, 오답 -1.5, 반복 재질문 -0.8, 주제 신호 +0.5.',
      howComputedGate: '승단에는 직접 증거가 필요합니다: 읽기·인용은 「접촉」까지만; 새 퀴즈 1문항 정답으로 「친숙」 해제, 48시간 이후 또 다른 새 문항 정답으로 「숙달」 해제됩니다.',
      howComputedDecay: '증거는 시간이 지나면 감쇠합니다: 복습하지 않으면 유효 숙달도가 점차 떨어집니다.',
      howComputedTiers: '등급은 유효 숙달도 기준: 접촉함 ≥ 30% (점등), 익숙함 ≥ 55%, 숙달함 ≥ 80%.',
      evidenceRefs: '{n}개 원문 조각 기반',
      recommendTitle: '다음에 볼 것',
      recommendEmpty: '추천 항목이 없습니다',
      reasonAffinity: '자주 쓰는 문서가 이 노드와 관련됩니다',
      reasonFrontier: '지식 경계의 다음 단계',
      reasonConsolidate: '접촉한 가장자리 다지기',
      reasonReview: '복습 필요: 숙련도가 감쇠 중입니다',
      reasonRemedial: '오답 복습: 이전에 오답한 노드',
      reasonStruggling: '반복 재질문: 이 노드가 여러 번 재질문됨',
      ...
      practice: '연습',
      quizTitle: '연습: {slug}',
      quizEmpty: '이 노드에는 아직 문제가 없습니다',
      submitAnswer: '제출',
      nextQuestion: '다음 문제',
      evidenceSource: '근거 출처',
      nextReviewDays: '복습 계획: 이 노드는 약 {n}일 유지됩니다',
      reviewNow: '복습 계획: 이 노드를 빠짐없이 곧 다져보세요',
      ...
      pEffMove: '유효 숙달도 {from}% → {to}%',
      progressZoneTitle: '내 진도',
      todayAnswers: '오늘 {n}문항 · 정답 {m}',
      todayLit: '오늘 {n}개 노드 점등',
      todayEvents: '오늘 기록 {n}건',
      todayEventsNote: '오늘 생성된 학습 이벤트 수: 페이지 열람, 답변 인용, 퀴즈 응시, 자기 평가',
      todayCardTitle: '오늘 복습할 것',
      todoDemoted: '강등됨 · 복습 필요',
      todoDue: '강등 임박',
      reasonRemedialShort: '오답 재연습',
      reasonStrugglingShort: '반복 재질문',
      reasonStuckShort: '선수 지식 미숙',
      hintFirstTouch: '페이지를 읽거나 질문하면 점등됩니다',
      hintQuizUnlockFamiliar: '새 퀴즈 1문항 정답으로 「친숙」 해제',
      hintQuizUnlockMastered: '다른 날 새 문항 정답으로 「숙달」 해제',
      hintGrowMastery: '퀴즈를 계속 맞혀 숙달도를 높이세요',
      hintKeepReviewing: '복습 일정을 지키면 단계가 유지됩니다',
      evUnsure: '잘 모름 선언',
      hoverOpenNode: '이 지식 페이지 열기',
      tierNodeTip: '유효 숙달도 {p}% · 증거 {n}건 · 클릭하면 열립니다',
      tlNodeChipTip: '이 노드의 학습 이벤트 {n}건 필터',
      evidenceSourceTip: '이 문제의 근거 문서 보기',
      constellationTitle: '지식 별자리',
      constellationLit: '점등',
      constellationHint: '안쪽 고리일수록 숙달도 깊음 · 점이 클수록 증거 많음 · 점선=증거 부족 · 호박색=퇴색 · 반짝임=48시간 내 학습 · 노드 클릭 시 열림',
      constellationHoverP: '유효 숙달도 {p}%',
      ...
      answerCorrect: '정답',
      answerWrong: '오답',
      timelineTitle: '점등 타임라인',
      selfAssessSection: '이 등급이 부정확하다고 생각하시나요?',
      selfAssessUp: '더 잘 알고 있어요',
      selfAssessDown: '덜 알고 있어요',
      selfAssessUpDone: '점수를 숙련 구간으로 올렸습니다. 정답 1개로 친숙, 다음 날 또 1개로 숙련이 열립니다',
      selfAssessDownDone: '선택한 사유로 숙달도를 조정했습니다',
      selfAssessFailed: '자기평가 제출 실패, 다시 시도해 주세요',
      selfAssessDialogTitle: '어떤 부분이 미숙한가요?',
      selfAssessSubmit: '제출',
      saReasonAll: '전반적으로 미숙 (이전에 오답 클릭)',
      saReasonAllHint: '이 노드의 숙련도 점수를 0으로 초기화',
      ...
      saBadgeUp: '자기평가: 상향 (퀴즈 검증 대기)',
      saBadgeDownAll: '자기평가: 초기화',
      saBadgeDownDocGap: '자기평가: 하향 (문서 미커버)',
      saBadgeDownDocUpdated: '자기평가: 하향 (문서 갱신)',
      saBadgeDownQuizEasy: '자기평가: 하향 (퀴즈 과다)',
      evSelfAssessUp: '자기평가 상향',
      evSelfAssessDownAll: '자기평가 초기화',
      evSelfAssessDownDocGap: '자기평가 강등: 문서 미커버',
      evSelfAssessDownDocUpdated: '자기평가 강등: 문서 갱신',
      evSelfAssessDownQuizEasy: '자기평가 강등: 퀴즈 타당성',
      ...
      tlFewerNodes: '접기',
      profileTitle: '프로필 관리',
      stopCollect: '내 학습 데이터 수집 중지',
      export: '프로필 내보내기',
      delete: '프로필 삭제',
      deleteConfirmTitle: '학습 프로필 삭제',
      deleteConfirmBody: '모든 학습 이벤트, 숙달 상태, 주제 매핑, 퀴즈 기록이 삭제됩니다(공유 문제 은행은 유지). 되돌릴 수 없습니다.',
    },
