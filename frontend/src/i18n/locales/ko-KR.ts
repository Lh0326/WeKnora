export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      howComputedGate: '승단에는 직접 증거가 필요합니다: 읽기·인용은 「접촉함」까지만; 새 검증 문항 1개 통과로 「친숙함」 해제, 48시간 이후 또 다른 새 문항 통과로 「검증됨」 해제됩니다.',
      ...
      reasonSelfVerify: '자체 판정 확인 대기: 방금 표시한 지식입니다 — 검증으로 확인하세요',
      changesTitle: '망각 동향',
