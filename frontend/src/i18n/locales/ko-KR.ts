export default {
  ...
  error: {
    ...
    streamInterrupted: '이전 답변이 중단되었습니다(서비스 재시작 또는 스트림 만료). 질문을 다시 보내주세요',
    initialization: {
      checkFailed: '검사 실패',
      testFailed: '테스트 실패'
    },
  ...
  knowledgeEditor: {
    learningTab: {
      tabLearning: '학습',
      title: '지식 네트워크 커버리지와 안내',
      litOf: '{total}개 중 {lit}개 노드 커버됨',
      noNodes: '지식 네트워크가 아직 생성되지 않았습니다 — 먼저 그래프에서 페이지를 만들어 보세요',
      goGraph: '그래프 열기',
      lowConfidenceTip: '증거가 3건 미만이므로 등급은 참고용입니다',
      tlFilteredEmpty: '지금까지 불러온 기록에 일치하는 항목이 없습니다',
      tlLoadMore: '더 불러오기',
      constellationMore: '신호가 약한 노드 {n}개는 그래프에 표시되지 않았습니다',
      unitsTitle: '폴더별 진도',
      rootUnit: '루트',
      masteredOf: '{n}개 검증됨',
      practiceN: '지식 검증 · {n}문제',
      levelKeep: '현재 등급: {level} · 유효 친숙도 {p}%',
      levelUpdate: '친숙도: {from} → {to}',
      optedOutNote: '수집 중지됨: 이번 답안은 기록되지 않고 친숙도도 변하지 않습니다',
      collectOnNote: '수집 중지됨: 질문과 지식 검증이 더 이상 학습 기록을 만들지 않습니다',
      profileSummary: '지식 노드 {nodes}개 · 학습 이벤트 {events}건 · 최근 활동 {last}',
      tierListEmpty: '이 등급에 노드가 없습니다',
      tlFilterAll: '전체',
      tlFilterCite: '질문',
      tlFilterCross: '재인용',
      tlFilterReAsk: '재질문',
      ...
      tlToday: '오늘',
      tlYesterday: '어제',
      reAskHint: '이 지식을 아직 완전히 이해하지 못했을 수 있습니다: 위키 페이지를 읽거나 지식 검증으로 확인해 보세요',
      deleteAlsoOptOut: '수집도 함께 중지 (삭제 후 새 데이터 수집 안 함)',
      badgeEntity: '엔티티',
      timelineEnd: '마지막입니다 · 총 {n}개',
      badgeConcept: '컨셉',
      tierUnseen: '미커버',
      tierFaded: "약해짐",
      explainTitle: "이 친숙도 등급인 이유?",
      explainPEff: "유효 친숙도 {p}% (시간 감쇠 반영)",
      explainThresholds: "커버 ≥30%, 친숙 ≥55%, 검증 ≥80%",
      explainEvidence: "학습 증거: 긍정 {pos}개 · 부정 {neg}개",
      explainFaded: "이 지식은 접촉한 적이 있지만 검증 미통과와 반복 재질문으로 친숙도가 낮아졌고 증거가 시간에 따라 감쇠하여 미커버로 떨어졌습니다 — 검증 한 세트를 통과하면 빠르게 회복됩니다",
      explainImprove: "향상 방법: 검증 통과 +2.2 · 다음 날 다시 읽기 +0.5 · 다른 질문에서 재방문 +1.6",
      tierTouched: '접촉함',
      tierFamiliar: '친숙함',
      tierMastered: '검증됨',
      tierHintUnseen: '아직 학습 증거 없음',
      tierHintTouched: '유효 친숙도 ≥ 30% (커버로 간주)',
      tierHintFamiliar: '유효 친숙도 ≥ 55%, 검증 통과 필요',
      tierHintMastered: '유효 친숙도 ≥ 80%, 다른 날 서로 다른 검증 문항 2개 통과 필요',
      howComputedTitle: '진도 계산 방법',
      howComputedSignals: '답변 인용, 페이지 읽기, 지식 검증이 모두 해당 노드에 친숙도 증거를 누적합니다: 답변 인용 +1.0, 페이지 읽기 +0.5(열 때마다 학습 궤적에 기록, 점수는 48시간 1회), 다른 질문에서 재방문 +1.6, 검증 통과 +2.2, 검증 미통과 -1.5, 반복 재질문 -0.8, 주제 신호 +0.5.',
      howComputedGate: '단계 상승에는 직접 증거가 필요합니다. 읽기와 인용은 「접촉함」까지만 반영됩니다. 독립적으로 한 문항을 맞히면 「친숙함」이 열리고, 서로 다른 문항을 2개 이상 맞히면서 48시간 이상 간격의 독립 평가에서도 정답을 내면 「검증됨」이 열립니다. 피드백 후 48시간 이내 같은 문항 재시도는 해설만 제공하며 능력 증거를 추가하지 않습니다.',
      howComputedDecay: '증거는 시간이 지나면 감쇠합니다: 장기간 보강하지 않으면 유효 친숙도가 점차 떨어집니다.',
      howComputedTiers: '등급은 유효 친숙도 기준: 접촉함 ≥ 30% (커버), 친숙함 ≥ 55%, 검증됨 ≥ 80%.',
      evidenceRefs: '{n}개 원문 조각 기반',
      recommendTitle: '커버리지 제안',
      rsAffinity: '관련',
      rsFrontier: '다음',
      rsFoundation: '여기서 시작',
      rsContinue: '이어서',
      ...
      rsExplore: '새로운 것',
      rsSelfVerify: '확인 대기',
      recommendEmpty: '추천 항목이 없습니다',
      zoneStartHere: '여기서 시작',
      zoneCountTip: '점등 {lit} / 전체 {total} («이미 알아요, 제외»도 점등으로 포함)',
      zoneThenNote: '① 완료 후 이어짐',
      zoneActionsBtn: '자기평가 / 알고 있음',
      zoneHintUnseen: '열어 읽으면 점등됩니다; 읽은 후에도 퀴즈로 단계가 오를 때까지 ①에 계속 표시됩니다',
      zoneHintTouched: '이미 읽었습니다 — 페이지에서 퀴즈를 풀면 「친숙」으로 상승',
      zoneHintFamiliar: '잘하고 있습니다 — 다른 날 2문제를 통과하면 「검증됨」',
      zoneHintFaded: '전에 배웠지만 잊혀졌습니다; 퀴즈로 빠르게 복구',
      zoneQuizAvail: '퀴즈 {n}문제 준비됨',
      objProgressVerified: '검증됨 {v}/{t} 학습 목표',
      objProgressConflicting: ', {n}개 충돌(재검증 필요)',
      objProgressStale: ', {n}개 만료(콘텐츠 갱신됨)',
      objProgressPartial: ', {n}개 부분 통과(한 그룹)',
      objProgressUntested: ', {n}개 미테스트',
      objProgressContact: '접촉 {c}/{n} 노드(접촉≠검증)',
      objProgressSelfReport: '{n}개 자기평가(검증 대기)',
      pathTitle: '학습 경로',
      pathEmpty: '추천 경로 없음 — 학습 목표를 설정하세요',
      pathMinutes: '분',
      pathRequires: '선수조건',
      pathActOverview: '개요',
      pathActRead: '읽기',
      ...
      pathActVerify: '검증',
      pathActReview: '복습',
      pathWhyFirstContact: '첫 접촉 — 기본 이해를 위해 읽기',
      pathWhyPractice: '접촉했으나 미검증 — 연습 후 도전',
      pathWhyVerify: '기초 완비 — 검증 계약 완료',
      pathWhyBridge: '선수지식 먼저 보충',
      pathWhyBridgeFail: '반복 실패 — 다른 방식으로 보충',
      pathWhyReview: '검증됐으나 오래됨 — 복습으로 확인',
      pathWhySuccessor: '선수과목 검증됨 — 다음 단계',
      pathWhyContinue: '최근 학습 흐름延续',
      pathWhyFastTrack: '빠른 도전 — 이미 아는 것 검증',
      pathWhyFallback: '가장 이른 미접촉 노드부터',
      pathDegradeNoContent: '콘텐츠 없음 — 문서 업로드 후 Wiki 생성',
      pathDegradeOrientation: '가장 이른 미접촉 노드부터 시작',
      objProgressGoalScope: '선택 목표: 검증 {v}/{t} (목표 제거는 전체 커버리지에 영향 없음)',
      pathActionEnter: '시작',
      pathActionChallenge: '도전',
      pathActionDisagree: '동의 안 함',
      nodeContactedYes: '접촉함',
      nodeContactedNo: '미접촉',
      nodeSelfUp: '자기평가: 더 앎',
      nodeSelfDown: '자기평가: 덜 앎',
      nodeLastVerified: '마지막 검증',
      nodeNextVerified: '다음: 후속 목표로',
      nodeNextConflicting: '다음: 새 검증 라운드',
      nodeNextStale: '다음: 새 콘텐츠로 재검증',
      nodeNextPartial: '다음: 두 번째 그룹 통과',
      nodeNextUnverified: '다음: 읽기+연습+검증',
      nodeNextRetired: '건너뜀(복구 가능)',
      nodeNextChallenge: '도전 대기 중',
      pathActionSwitchMaterial: '자료 변경',
      pathActionViewEvidence: '증거 보기',
      pathActionExport: '프로필 내보내기',
      pathActionDelete: '프로필 삭제',
      zonePathCaption: '학습 경로(쉬운 것부터; 노드를 클릭하면 바로 학습)',
      zonePathLegend: '우측의 색상 배지 = 해당 노드의 단계와 유효 친숙도',
      zoneExpandPath: '경로 펼치기 (총 {n})',
      zoneCollapsePath: '경로 접기',
      zoneCurrentMark: '현재',
      reasonAffinity: '자주 쓰는 문서가 이 지식과 관련됩니다',
      reasonFrontier: '지식 경계의 다음 단계',
      reasonConsolidate: '접촉한 가장자리 보강',
      reasonReview: '보강 필요: 친숙도가 감쇠 중입니다',
      reasonRemedial: '재검증 필요: 이전에 검증을 통과하지 못한 지식',
      reasonStruggling: '반복 재질문: 이 지식이 여러 번 재질문됨',
      reasonStuck: '선수 지식이 오랫동안 검증되지 않았습니다 — 먼저 보완하세요',
      reasonBypass: '선수 지식에 막혀 있습니다 — 인접 노드부터 보세요',
      reasonExplore: '미개척 영역 탐색',
      reasonSelfVerify: '자체 판정 확인 대기: 새 문항 1개 통과로 「친숙함」, 다음 날 또 1개로 「검증됨」이 열립니다',
      reasonFoundation: '입문 시작점: 자료 서두에 위치 — 처음부터 학습하는 첫 정거장',
      reasonContinue: '이어서: 방금 배운 것의 다음 단계',
      zoneIntro: '「현재」 표시를 따라 학습하세요: 단계를 다지면 경로를 따라 진행됩니다; 펼쳐서 전체 경로를 확인하세요. 우측 상단 = 점등/전체 («이미 알아요, 제외»도 점등으로 포함)',
      zoneDone: '모듈 전체 점등 완료',
      zoneNextMark: '이 모듈의 첫 단계',
      constellationHint3d: '안쪽 링 = 검증됨 · 부채꼴 = 모듈 · 호버로 관계 확인 · 휠 확대 · 드래그로 시점 회전 · 더블 클릭 초기화',
      constellationDustHint: '미접촉 노드 {n}개 — 클릭하여 펼치기',
      whyFirstStop: '서두 첫 정거장 — 여기서 전체 그림을 세웁니다',
      whyMaterialStart: '자료 {rank}번째 — 「{section}」의 시작 노드',
      whyContinuesPrereq: '방금 배운 《{ref}》를 이어받는 자연스러운 다음 단계',
      whyContinuesPrev: '이전 추천 《{ref}》의 다음 단계 — 차례로 이어집니다',
      whySameSection: '방금 배운 《{ref}》와 같은 「{section}」 — 바로 이어서 학습',
      whyChapterOf: '「{label}」 소속',
      whyInDoc: '《{label}》 출처',
      skipAction: '이미 알고 있음 — 추천에서 제외',
      skipNote: '「이미 알고 있음 — 추천에서 제외」: 제외된 노드는 「다음에 볼 것」과 복습 알림에서 사라지며 등급 목록에서 복원할 수 있습니다',
      skipDone: '추천 대기열에서 제외했습니다',
      skipRestored: '추천을 복원했습니다',
      skipFailed: '작업에 실패했습니다. 다시 시도해 주세요',
      skippedTag: '건너뜀',
      skippedBadge: '건너뜀: 직접 숙달 선언(노드를 열어 학습할 수 있고 등급 목록에서 복원 가능)',
      restoreSkip: '복원',
      selfVerifyGoVerify: '검증 완료하기',
      selfVerifyQuizPending: '검증 문항 생성 중 — 먼저 페이지를 읽어보세요; 문항이 준비되면 1개 통과로 「친숙함」이 열립니다',
      recommendOrderIntro: '자료 순서대로 쉬운 것부터 배치: 1번부터 차례로 학습하세요 (디렉터리 태그는 소속 표시)',
      recommendStartHere: '시작점',
      explainDocRank: '자료 위치: {n}번째 (1 = 서두, 추천은 이 순서를 따릅니다)',
      explainSource: '출처: 「{section}」 · 《{doc}》',
      selfAssessUpDoneNoQuiz: '점수를 올렸습니다; 검증 문항이 생성되면 1개 통과로 「친숙함」이 열립니다',
      tierListLoadFailed: '목록 로드에 실패했습니다',
      changesIdle: '{d}일 미접촉',
      changesNext: '약 {n}일 후 강등',
      openPage: '열기',
      practice: '지식 검증',
      quizTitle: '지식 검증: {slug}',
      quizEmpty: '이 지식에는 아직 검증 문항이 없습니다',
      submitAnswer: '제출',
      nextQuestion: '다음 문제',
      evidenceSource: '근거 출처',
      nextReviewDays: '신선도 전망: 이 지식은 약 {n}일 더 유지될 수 있습니다',
      reviewNow: '신선도 전망: 이 지식을 가능한 한 빨리 검증하세요',
      kbdHint: 'A–D 선택 · E 잘 모름 · Enter 제출',
      unsureOption: '잘 모르겠습니다 — 해설 먼저 보기',
      answerUnsure: '「잘 모름」을 선택했습니다',
      unsureNote: '확실하지 않음 선택은 득점도 감점도 없습니다: 아래 해설을 확인한 후 다른 날 다시 응시할 수 있습니다.',
      pEffMove: '유효 친숙도 {from}% → {to}%',
      todayAnswers: '오늘 검증 {n} · 통과 {m}',
      todayLit: '오늘 새로 커버된 노드 {n}개',
      todayEvents: '오늘 기록 {n}건',
      todayEventsNote: '오늘 생성된 학습 이벤트 수: 페이지 열람, 답변 인용, 지식 검증, 자체 판정',
      todayCardTitle: '오늘 보강할 것',
      todoDemoted: '강등됨 · 보강 필요',
      todoDue: '강등 임박',
      reasonRemedialShort: '재검증',
      reasonStrugglingShort: '반복 재질문',
      reasonStuckShort: '선수 지식 미검증',
      hintFirstTouch: '페이지를 읽거나 질문하면 커버됩니다',
      hintQuizUnlockFamiliar: '새 검증 문항 1개 통과로 「친숙함」 해제',
      hintQuizUnlockMastered: '다른 날 새 문항 통과로 「검증됨」 해제',
      hintGrowMastery: '검증을 계속 통과해 친숙도를 높이세요',
      hintKeepReviewing: '신선도 전망에 따라 보강하면 등급이 유지됩니다',
      evUnsure: '잘 모름 선언',
      hoverOpenNode: '이 지식 페이지 열기',
      tierNodeTip: '유효 친숙도 {p}% · 증거 {n}건 · 클릭하면 열립니다',
      tlNodeChipTip: '이 노드의 학습 이벤트 {n}건 필터',
      evidenceSourceTip: '이 검증 문항의 근거 문서 보기',
      constellationTitle: '지식 별자리',
      constellationLit: '커버됨',
      constellationHint: '안쪽 고리일수록 친숙도 깊음 · 점이 클수록 증거 많음 · 점선=증거 부족 · 호박색=약해짐 · 반짝임=48시간 내 접촉 · 노드 클릭 시 열림',
      constellationHoverP: '유효 친숙도 {p}%',
      constellationHoverN: '학습 증거 {n}건',
      quizLoadFailed: '문제 로드 실패, 잠시 후 다시 시도하세요',
      loadError: '학습 데이터 로드 실패 — 서비스를 확인 후 재시도하세요',
      retry: '재시도',
      collectKeptNote: '수집 중지는 신규 기록만 멈춥니다; 기존 {n}건 기록은 유지되며 언제든 내보내기·삭제할 수 있습니다',
      deleteIrreversible: '이 작업은 되돌릴 수 없음을 이해합니다',
      loadFailed: '학습 데이터 로드 실패',
      submitFailed: '답변 제출 실패',
      exportFailed: '프로필 내보내기 실패',
      deleteDone: '프로필 삭제됨',
      deleteFailed: '프로필 삭제 실패',
      toggleFailed: '설정 실패, 되돌림',
      answerCorrect: '정답',
      answerWrong: '오답',
      timelineTitle: '학습 궤적',
      selfAssessSection: '이 친숙도 판정이 부정확하다고 생각하시나요?',
      selfAssessUp: '이 지식이 더 친숙해요',
      selfAssessDown: '이 지식은 서먹해졌어요',
      selfAssessUpDone: '점수를 「검증됨」 구간으로 올렸습니다. 통과 1개로 「친숙함」, 다음 날 또 1개 통과로 정식으로 「검증됨」이 열립니다',
      selfAssessDownDone: '선택한 사유로 친숙도를 조정했습니다',
      selfAssessFailed: '자체 판정 제출 실패, 다시 시도해 주세요',
      selfAssessDialogTitle: '어떤 부분이 친숙하지 않나요?',
      selfAssessSubmit: '제출',
      saReasonAll: '전반적으로 미숙 (이전에 오답 클릭)',
      saReasonAllHint: '이 지식의 친숙도를 0으로 초기화하고 커버리지를 다시 구축합니다',
      saReasonDocGap: '문서가 이 부분을 다루지 않음',
      saReasonDocGapHint: '한 단계 강등, 문서 커버리지 격차 기록',
      saReasonDocUpdated: '문서에 새 내용이 추가됨',
      saReasonDocUpdatedHint: '한 단계 강등, 지식 갱신 필요 기록',
      saReasonQuizEasy: '퀴즈가 너무 쉬웠음',
      saReasonQuizEasyHint: '한 단계 강등, 퀴즈 타당성 문제 기록',
      saBadgeUp: '자체 판정: 상향 (검증 대기 — 새 문항 1개 통과로 「친숙함」, 다음 날 또 1개로 「검증됨」)',
      saBadgeDownAll: '자체 판정: 초기화',
      saBadgeDownDocGap: '자체 판정: 하향 (문서 미커버)',
      saBadgeDownDocUpdated: '자체 판정: 하향 (문서 갱신)',
      saBadgeDownQuizEasy: '자체 판정: 하향 (문항이 너무 쉬움)',
      evSelfAssessUp: '자체 판정 상향',
      evSelfAssessDownAll: '자체 판정 초기화',
      evSelfAssessDownDocGap: '자체 판정 강등: 문서 미커버',
      evSelfAssessDownDocUpdated: '자체 판정 강등: 문서 갱신',
      evSelfAssessDownQuizEasy: '자체 판정 강등: 문항 타당성',
      timelineTodayCount: '오늘 학습 기록 {n}건',
      timelineEmpty: '아직 학습 이벤트가 없습니다',
      evCite: '인용됨',
      evCross: '재방문',
      evReAsk: '재질문',
      evTopic: '주제 신호',
      ...
      evAgentRead: '어시스턴트 조회',
      evQuizOk: '검증 통과',
      evQuizBad: '검증 미통과',
      evBackfill: '이력',
      profileScopeNote: '아래 작업은 모든 지식 베이스의 학습 프로필에 적용됩니다',
      tlMoreNodes: '전체 {n}개 노드 보기',
      tlFewerNodes: '접기',
      profileTitle: '프로필 관리',
      stopCollect: '내 친숙도 데이터 수집 중지',
      export: '프로필 내보내기',
      delete: '프로필 삭제',
      deleteConfirmTitle: '학습 프로필 삭제',
      deleteConfirmBody: '모든 학습 이벤트, 친숙도 상태, 주제 매핑, 검증 기록이 삭제됩니다(공유 문제 은행은 유지). 되돌릴 수 없습니다.',
      // ---- 지식 건강(owner/admin 조직 보기) 및 역할 커버리지 계획 ----
      viewPersonal: '개인 보기',
      viewHealth: '지식 건강',
      healthTitle: '지식 자산 건강',
      healthLoadFailed: '건강 데이터를 불러오지 못했습니다',
      healthSummaryNodes: '지식 노드 {total}개',
      healthSummaryCovered: '{n}개 커버됨',
      healthSummarySubjects: '학습 기록 {n}명',
      healthFoldersTitle: '폴더 커버리지',
      healthFolderCovered: '{covered}/{total}',
      healthExpertsTitle: '전문가 분포(친숙 인원 기준)',
      healthExpertCount: '{n}명 친숙',
      healthRisksTitle: '지식 리스크',
      riskSinglePoint: '단일 지점 지식: 1명만 친숙',
      riskStaleDoc: '잊힌 문서 지식: 학습 이력이 있으나 현재 전원의 친숙도가 감쇠됨',
      healthMaintenanceTitle: '거버넌스 수신함',
      maintPendingVerify: '검증 대기 중인 자체 판정',
      maintDownAll: '자체 판정: 초기화됨',
      maintDocGap: '문서 커버리지 공백',
      maintDocUpdated: '지식 만료(문서 업데이트)',
      maintQuizEasy: '검증 문항 타당성 의심(너무 쉬움)',
      maintLatestAt: '최근 {t}',
      maintEmpty: '유지관리 표시 없음',
      risksEmpty: '리스크 없음',
      expertsEmpty: '친숙도 기록 없음',
      rolePlanTitle: '역할 커버리지 계획',
      rolePlanIntro: '폴더별로 묶은 커버리지 제안 — 담당 범위의 미커버·보강 대상 지식부터 우선 채우세요',
    },
    ...
    wikiBrowser: {
      ...
      mcSummary: '유효 친숙도 {p}% · 증거 {n}건',
      mcLastTouch: '최근 접촉',
      mcOpenNode: '노드를 클릭하면 페이지가 열립니다',
      mcQuizN: '사용 가능한 퀴즈 {n}문제',
      mcLowConf: '증거 부족(3건 미만), 등급은 참고용입니다',
      masteryLegendNew: 'NEW = 이번 세션에 새로 켜짐',
      masteryNoRing: '링 없음 · 미커버',
      masteryLowConfBadge: '낮은 신뢰도 (점선 링)',
      masteryUnseen: '퇴색됨 (기록 있음)',
      masteryTouched: '접촉함',
      masteryFamiliar: '친숙함',
      masteryMastered: '검증됨',
      ...
      issuePagePrefix: '페이지: ',
      issueGoFix: '수정하러 가기',
      assistantName: '지식 도우미',
      assistantNewChat: '새 대화',
      assistantTitle: 'WeKnora 지식 어시스턴트',
      assistantSceneWikiPage: '현재 화면: 지식 노드 «{title}» 페이지',
      assistantSceneWiki: '현재 화면: 위키 지식 네트워크',
      assistantSceneLearning: '현재 화면: 학습 탭 · 지식 별자리',
      assistantSceneDocuments: '현재 화면: 지식 문서',
      assistantSceneKb: '현재 화면: 지식 베이스',
      assistantTooltip: '지식 도우미에게 물어보기',
      assistantRetry: '세션 생성 실패 — 다시 시도하려면 클릭',
