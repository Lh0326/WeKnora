export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      tlToday: '오늘',
      tlYesterday: '어제',
      reAskHint: '이 노드를 아직 완전히 이해하지 못했을 수 있습니다. 위키 페이지를 읽거나 퀴즈를 풀어보세요',
      ...
      explainThresholds: "점등 ≥22%, 친숙 ≥55%, 숙달 ≥80%",
      ...
      tierHintFamiliar: '유효 숙달도 ≥ 55%',
      tierHintMastered: '유효 숙달도 ≥ 80%',
      ...
      recommendEmpty: '추천이 없습니다 — 먼저 질문을 해보세요',
      ...
      reasonRemedial: '오답 복습: 이전에 틀렸습니다 — 다시 도전해 보세요',
      reasonStruggling: '반복 재질문: 아직 제대로 이해하지 못했을 수 있어 연습 권장',
