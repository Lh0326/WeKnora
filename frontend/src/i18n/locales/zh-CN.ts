export default {
  ...
  knowledgeEditor: {
    learningTab: {
      tabLearning: '学习',
      title: '知识网络学习进度',
      litOf: '已点亮 {lit} / {total} 个知识节点',
      noNodes: '尚未生成知识网络，先在图谱中构建页面后再来看看',
      unitsTitle: '分组进度',
      rootUnit: '根目录',
      masteredOf: '其中 {n} 个已掌握',
      practiceN: '练一练 · {n} 题',
      levelKeep: '当前档位：{level} · 有效掌握度 {p}%',
      levelUpdate: '掌握度：{from} → {to}',
      optedOutNote: '已开启停采：本次作答不会被记录，掌握度不变',
      collectOnNote: '停采已开启：问答与测验不再产生学习记录',
      ...
      tlToday: '今天',
      tlYesterday: '昨天',
      reAskHint: '此节点可能尚未真正理解：可阅读 Wiki 页面或做一组测验验证',
      ...
      tierUnseen: '未接触',
      tierFaded: "已淡化",
      explainTitle: "为什么是这个档位？",
      explainPEff: "有效掌握度 {p}%（随时间衰减后）",
      explainThresholds: "点亮需 ≥30%，较熟悉 ≥55%，已掌握 ≥80%",
      explainEvidence: "学习证据：正向 {pos} 条 · 负向 {neg} 条",
      explainFaded: "此节点学过，但答错与重复追问拉低了掌握度，且证据随时间衰减，现跌回未点亮——答对一组测验即可快速拉回",
      explainImprove: "提升方式：答对测验 +2.2 · 跨天再读 +0.5 · 跨问题回访 +1.6",
      tierTouched: '已接触',
      tierFamiliar: '较熟悉',
      tierMastered: '已掌握',
      tierHintUnseen: '尚无学习证据',
      tierHintTouched: '有效掌握度 ≥ 30%（视为已点亮）',
      tierHintFamiliar: '有效掌握度 ≥ 55%，且答对过测验题',
      tierHintMastered: '有效掌握度 ≥ 80%，且隔天答对过 ≥2 道不同测验题',
      howComputedTitle: '进度如何计算',
      howComputedSignals: '问答引用、页面阅读与测验作答都会为命中的知识节点累积掌握证据：问答引用 +1.0、页面阅读 +0.5（每次打开都会记入时间线；48 小时内重复阅读只计一次分数）、跨题回访 +1.6、测验答对 +2.2、答错 -1.5、重复追问 -0.8、话题投射 +0.5。',
      howComputedGate: '升档需要直接证据：阅读与引用最高只能点亮到「已接触」；答对 1 道新测验题解锁「较熟悉」；隔天（间隔 ≥48 小时）再答对 1 道新题解锁「已掌握」。',
      howComputedDecay: '证据会随时间自然衰减：长期不复习，有效掌握度会逐步回落。',
      howComputedTiers: '档位按有效掌握度划分：已接触 ≥ 30%（即"点亮"）、较熟悉 ≥ 55%、已掌握 ≥ 80%。',
      evidenceRefs: '依据 {n} 个原文片段',
      recommendTitle: '下一步看什么',
      recommendEmpty: '暂无推荐',
      reasonAffinity: '你常用的文档涉及此节点',
      reasonFrontier: '知识边界上的下一步',
      reasonConsolidate: '巩固已接触的边缘',
      reasonReview: '待复习：掌握度正在衰减',
      reasonRemedial: '错题重练：此节点此前答错过',
      reasonStruggling: '反复追问：此节点被多次重复追问',
      ...
      nextQuestion: '下一题',
      evidenceSource: '证据来源',
      nextReviewDays: '复习计划：该节点预计可保持约 {n} 天',
      reviewNow: '复习计划：建议尽快巩固此节点',
      kbdHint: 'A–D 选择 · E 不确定 · Enter 提交',
      unsureOption: '不确定——先看解析再回来',
      answerUnsure: '你选择了「不确定」',
      unsureNote: '不确定不计分也不扣分：查看下方解析后，隔天可再次作答。',
      pEffMove: '有效掌握度 {from}% → {to}%',
      progressZoneTitle: '我的进度',
      todayAnswers: '今日答题 {n} · 答对 {m}',
      todayLit: '今日点亮 {n} 个节点',
      todayEvents: '今日记录 {n} 条',
      todayEventsNote: '今日产生的学习事件数：页面阅读、问答引用、测验作答与自评',
      todayCardTitle: '今日待巩固',
      todoDemoted: '已降档 · 需复习',
      todoDue: '临近降档',
      reasonRemedialShort: '错题重练',
      reasonStrugglingShort: '反复追问',
      reasonStuckShort: '前置未掌握',
      hintFirstTouch: '阅读页面或提问即可点亮',
      hintQuizUnlockFamiliar: '答对 1 道新测验题解锁「较熟悉」',
      hintQuizUnlockMastered: '隔天再答对 1 道新题解锁「已掌握」',
      hintGrowMastery: '继续答对测验提升掌握度',
      hintKeepReviewing: '按复习计划巩固即可保持档位',
      evUnsure: '不确定申报',
      hoverOpenNode: '点击打开这篇知识页面',
      tierNodeTip: '有效掌握度 {p}% · 证据 {n} 条 · 点击打开',
      tlNodeChipTip: '筛选该节点的 {n} 条学习事件',
      evidenceSourceTip: '查看这道题的证据来源文档',
      constellationTitle: '知识星图',
      constellationLit: '已点亮',
      constellationHint: '越靠内环掌握越深 · 圆点越大证据越多 · 虚线描边=证据不足 · 琥珀色=已淡化 · 闪烁=近 48 小时学过 · 点击节点打开页面',
      constellationHoverP: '有效掌握度 {p}%',
      ...
      answerWrong: '回答错误',
      timelineTitle: '点亮时间线',
      selfAssessSection: '觉得这个判断不准？',
      selfAssessUp: '我比这档更熟',
      selfAssessDown: '我比这档更生',
      selfAssessUpDone: '已把分数抬到「已掌握」区间；答对 1 道解锁「较熟悉」，隔天再答对 1 道正式解锁「已掌握」',
      selfAssessDownDone: '已按你选择的原因调整掌握度',
      selfAssessFailed: '自评提交失败，请重试',
      selfAssessDialogTitle: '哪方面不熟练？',
      selfAssessSubmit: '提交自评',
      saReasonAll: '全部不熟（之前误触）',
      saReasonAllHint: '将该知识节点的掌握度重置为零',
      ...
      saBadgeUp: '自评：更熟（待测验验证）',
      saBadgeDownAll: '自评：更生（已重置）',
      saBadgeDownDocGap: '自评：更生（文档不涉及）',
      saBadgeDownDocUpdated: '自评：更生（文档已更新）',
      saBadgeDownQuizEasy: '自评：更生（题目太简单）',
      evSelfAssessUp: '自评更熟',
      evSelfAssessDownAll: '自评重置',
      evSelfAssessDownDocGap: '自评降档·文档缺口',
      evSelfAssessDownDocUpdated: '自评降档·文档更新',
      evSelfAssessDownQuizEasy: '自评降档·题目效度',
      ...
      tlFewerNodes: '收起',
      profileTitle: '画像管理',
      stopCollect: '停止采集我的学习数据',
      export: '导出画像',
      delete: '删除画像',
      deleteConfirmTitle: '删除学习画像',
      deleteConfirmBody: '将删除你的全部学习事件、掌握度、话题映射与作答记录（题库保留）。此操作不可撤销。',
    },
    titleCreate: '新建知识库',
    titleEdit: '知识库设置',
    advanced: {
