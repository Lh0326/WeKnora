export default {
  ...
  error: {
    ...
    streamFailed: '流式连接失败',
    streamInterrupted: '上一条回复已中断（服务重启或连接过期），请重新发送问题',
    initialization: {
      checkFailed: '检查失败',
      testFailed: '测试失败'
    },
  ...
  knowledgeEditor: {
    learningTab: {
      tabLearning: '学习',
      title: '知识网络覆盖与引导',
      litOf: '已覆盖 {lit} / {total} 个知识节点',
      noNodes: '尚未生成知识网络，先在图谱中构建页面后再来看看',
      goGraph: '去图谱看看',
      lowConfidenceTip: '证据不足 3 条，档位仅供参考',
      tlFilteredEmpty: '当前已加载的记录中没有匹配项',
      tlLoadMore: '加载更多',
      constellationMore: '另有 {n} 个低信号节点未在图中展示',
      unitsTitle: '分组进度',
      rootUnit: '根目录',
      masteredOf: '其中 {n} 个已验证',
      practiceN: '知识校验 · {n} 题',
      levelKeep: '当前档位：{level} · 有效熟悉度 {p}%',
      levelUpdate: '熟悉度：{from} → {to}',
      optedOutNote: '已开启停采：本次作答不会被记录，熟悉度不变',
      collectOnNote: '停采已开启：问答与校验不再产生学习记录',
      profileSummary: '{nodes} 个知识节点 · {events} 条学习事件 · 最近活动 {last}',
      tierListEmpty: '该档暂无节点',
      tlFilterAll: '全部',
      tlFilterCite: '问答',
      tlFilterCross: '跨题回访',
      tlFilterReAsk: '重复追问',
      ...
      tlToday: '今天',
      tlYesterday: '昨天',
      reAskHint: '此知识可能尚未真正理解：可阅读 Wiki 页面或做一组校验确认',
      deleteAlsoOptOut: '同时开启停采（删除后不再采集新数据）',
      badgeEntity: '实体',
      timelineEnd: '已到底部 · 共 {n} 条记录',
      badgeConcept: '概念',
      tierUnseen: '未覆盖',
      tierFaded: "已淡化",
      explainTitle: "为什么是这个熟悉度档？",
      explainPEff: "有效熟悉度 {p}%（随时间衰减后）",
      explainThresholds: "覆盖需 ≥30%，熟悉 ≥55%，已验证 ≥80%",
      explainEvidence: "学习证据：正向 {pos} 条 · 负向 {neg} 条",
      explainFaded: "此知识接触过，但校验未过与重复追问拉低了熟悉度，且证据随时间衰减，现跌回未覆盖——通过一组校验即可快速拉回",
      explainImprove: "提升方式：校验通过 +2.2 · 跨天再读 +0.5 · 跨问题回访 +1.6",
      tierTouched: '已接触',
      tierFamiliar: '熟悉',
      tierMastered: '已验证',
      tierHintUnseen: '尚无学习证据',
      tierHintTouched: '有效熟悉度 ≥ 30%（视为已覆盖）',
      tierHintFamiliar: '有效熟悉度 ≥ 55%，且通过过校验题',
      tierHintMastered: '有效熟悉度 ≥ 80%，且隔天通过过 ≥2 道不同校验题',
      howComputedTitle: '进度如何计算',
      howComputedSignals: '问答引用、页面阅读与知识校验都会为命中的知识节点累积熟悉度证据：问答引用 +1.0、页面阅读 +0.5（每次打开都会记入学习轨迹；48 小时内重复阅读只计一次分数）、跨题回访 +1.6、校验通过 +2.2、校验未过 -1.5、重复追问 -0.8、话题投射 +0.5。',
      howComputedGate: '升档需要直接证据：阅读与引用最高只能覆盖到「已接触」；独立通过 1 道校验题解锁「熟悉」；通过至少 2 道不同题，并在间隔 ≥48 小时的有效测验中再次通过，解锁「已验证」。同题查看反馈后 48 小时内重答仍有讲解，但不重复计入能力证据。',
      howComputedDecay: '证据会随时间自然衰减：长期不巩固，有效熟悉度会逐步回落。',
      howComputedTiers: '档位按有效熟悉度划分：已接触 ≥ 30%（即"覆盖"）、熟悉 ≥ 55%、已验证 ≥ 80%。',
      evidenceRefs: '依据 {n} 个原文片段',
      recommendTitle: '覆盖建议',
      rsAffinity: '相关',
      rsFrontier: '下一步',
      rsFoundation: '从头开始',
      ...
      recommendEmpty: '暂无推荐',
      zoneStartHere: '从这开始',
      zoneCountTip: '已点亮 {lit} / 共 {total}（"已掌握，移除推荐"计为已点亮）',
      zoneThenNote: '完成①后接棒',
      zoneActionsBtn: '自评 / 已掌握',
      zoneHintUnseen: '打开阅读即可点亮；学到"已接触"后会继续排在①，直到练一练升档',
      zoneHintTouched: '已读过了——去页面里练一练，答对可升「熟悉」',
      zoneHintFamiliar: '已不错——隔天再通过 2 道不同校验题即可「已验证」',
      zoneHintFaded: '之前学过但淡忘了，重新练一练即可拉回',
      zoneQuizAvail: '有 {n} 题可练',
      objProgressVerified: '已验证 {v}/{t} 个学习目标',
      objProgressConflicting: '，其中 {n} 项存在冲突需复核',
      objProgressStale: '，{n} 项因内容更新待重验',
      objProgressPartial: '，{n} 项单题族通过（待补第二族）',
      objProgressUntested: '，{n} 项尚未测试',
      objProgressContact: '接触过 {c}/{n} 个知识节点（接触不等于已验证）',
      objProgressSelfReport: '{n} 项自述（待校验）',
      pathTitle: '学习路径',
      pathEmpty: '暂无推荐路径——设定学习目标后可获取',
      pathMinutes: '分钟',
      pathRequires: '前置条件',
      pathActOverview: '概览',
      pathActRead: '阅读',
      ...
      pathActVerify: '验证',
      pathActReview: '复核',
      pathWhyFirstContact: '首次接触此知识——先阅读建立基本认识',
      pathWhyPractice: '已接触但未验证——先练习再挑战',
      pathWhyVerify: '已有基础——完成验证契约即可证明能力',
      pathWhyBridge: '需先补学前置知识',
      pathWhyBridgeFail: '连续未通过——换一种方式补学前置',
      pathWhyReview: '已验证但间隔较久——建议复核确认',
      pathWhySuccessor: '前置已验证——进入下一阶段',
      pathWhyContinue: '延续最近的学习线程',
      pathWhyFastTrack: '快速挑战——直接验证已掌握的知识',
      pathWhyFallback: '从资料顺序起点开始',
      pathDegradeNoContent: '暂无可用知识内容——上传文档并生成 Wiki 后重试',
      pathDegradeOrientation: '推荐从最早的未接触节点开始浏览',
      objProgressGoalScope: '所选目标：已验证 {v}/{t}（移出目标不影响全库覆盖）',
      pathActionEnter: '进入学习',
      pathActionChallenge: '直接挑战',
      pathActionDisagree: '状态不符',
      nodeContactedYes: '已接触',
      nodeContactedNo: '未接触',
      nodeSelfUp: '自述更熟',
      nodeSelfDown: '自述更生',
      nodeLastVerified: '最后验证',
      nodeNextVerified: '下一步：进入后续目标',
      nodeNextConflicting: '下一步：完成新验证回合恢复',
      nodeNextStale: '下一步：按新内容复核',
      nodeNextPartial: '下一步：补第二题族',
      nodeNextUnverified: '下一步：阅读+练习+验证',
      nodeNextRetired: '已跳过（可恢复推荐）',
      nodeNextChallenge: '待挑战确认',
      pathActionSwitchMaterial: '换材料',
      pathActionViewEvidence: '查看证据',
      pathActionExport: '导出画像',
      pathActionDelete: '删除画像',
      zonePathCaption: '学习路径（从浅入深，点击任意节点直接学）',
      zonePathLegend: '右侧彩色徽标 = 该节点的档位与有效熟悉度',
      zoneExpandPath: '展开学习路径（共 {n} 站）',
      zoneCollapsePath: '收起路径',
      zoneCurrentMark: '当前',
      reasonAffinity: '你常用的文档涉及此知识',
      reasonFrontier: '知识边界上的下一步',
      reasonConsolidate: '巩固已接触的边缘',
      reasonReview: '待巩固：熟悉度正在衰减',
      reasonRemedial: '需重新校验：此知识此前校验未过',
      reasonStruggling: '反复追问：此知识被多次重复追问',
      reasonStuck: '前置知识长期未验证，建议先补',
      reasonBypass: '目标被前置卡住，先看相邻节点',
      reasonExplore: '探索一个盲区',
      reasonSelfVerify: '自主认定待确认：通过 1 道新题解锁「熟悉」，隔天再通过 1 道解锁「已验证」',
      reasonFoundation: '入门起点：位于资料开篇位置，从零起步的第一站',
      reasonContinue: '顺承：接着刚学的往下',
      zoneIntro: '跟着「当前」标记学：学完一档它会沿路径前进；展开可回看全程。右上角 = 已点亮/总数，"已掌握，移除推荐"计为已点亮',
      zoneDone: '本模块已全部点亮',
      zoneNextMark: '当前模块第一步',
      constellationHint3d: '内环=已验证 · 扇区=知识区 · 悬停看关系 · 滚轮缩放 · 拖拽旋转视角 · 双击复位',
      constellationDustHint: '未接触节点 {n} 个，点击展开',
      whyFirstStop: '开篇第一站——从这里建立全局图景',
      whyMaterialStart: '资料第 {rank} 位，「{section}」的开篇节点',
      whyContinuesPrereq: '承接你刚学的《{ref}》——它是下一步的自然延伸',
      whyContinuesPrev: '承接上一个推荐《{ref}》，一步接一步',
      whySameSection: '与刚学的《{ref}》同属「{section}」，适合紧接着学',
      whyChapterOf: '属于「{label}」',
      whyInDoc: '出自《{label}》',
      skipAction: '已掌握，移出推荐',
      skipNote: '「已掌握，移出推荐」：移出后不再出现在「下一步看什么」与遗忘提醒里；档位清单中可随时恢复',
      skipDone: '已把该知识点移出推荐队列',
      skipRestored: '已恢复推荐',
      skipFailed: '操作失败，请重试',
      skippedTag: '已跳过',
      skippedBadge: '已跳过：自认已掌握（点开节点仍可学习，档位清单可恢复推荐）',
      restoreSkip: '恢复推荐',
      selfVerifyGoVerify: '去完成校验',
      selfVerifyQuizPending: '校验题生成中——可先阅读页面，题目就绪后通过 1 道即可解锁「熟悉」',
      recommendOrderIntro: '按资料由浅入深排列：从 1 号开始依次往下学即可，目录标签仅表示归属',
      recommendStartHere: '第一站',
      explainDocRank: '资料位次：第 {n} 位（开篇为第 1 位，推荐按此顺序铺路）',
      explainSource: '出处：「{section}」·《{doc}》',
      selfAssessUpDoneNoQuiz: '已抬分；校验题生成后，通过 1 道即可解锁「熟悉」',
      tierListLoadFailed: '清单加载失败',
      changesIdle: '已闲置 {d} 天',
      changesNext: '约 {n} 天后降档',
      openPage: '查看',
      practice: '知识校验',
      quizTitle: '知识校验：{slug}',
      quizEmpty: '该知识暂无校验题',
      ...
      nextQuestion: '下一题',
      evidenceSource: '证据来源',
      nextReviewDays: '保鲜预期：该知识预计还可保持约 {n} 天',
      reviewNow: '保鲜预期：建议尽快校验此知识',
      kbdHint: 'A–D 选择 · E 不确定 · Enter 提交',
      unsureOption: '不确定——先看解析再回来',
      answerUnsure: '你选择了「不确定」',
      unsureNote: '不确定不计分也不扣分：查看下方解析后，隔天可再次作答。',
      pEffMove: '有效熟悉度 {from}% → {to}%',
      todayAnswers: '今日校验 {n} · 通过 {m}',
      todayLit: '今日新增覆盖 {n} 个节点',
      todayEvents: '今日记录 {n} 条',
      todayEventsNote: '今日产生的学习事件数：页面阅读、问答引用、知识校验与自主认定',
      todayCardTitle: '今日待巩固',
      todoDemoted: '已降档 · 需巩固',
      todoDue: '临近降档',
      reasonRemedialShort: '重新校验',
      reasonStrugglingShort: '反复追问',
      reasonStuckShort: '前置未验证',
      hintFirstTouch: '阅读页面或提问即可建立覆盖',
      hintQuizUnlockFamiliar: '通过 1 道新校验题解锁「熟悉」',
      hintQuizUnlockMastered: '隔天再通过 1 道新题解锁「已验证」',
      hintGrowMastery: '继续通过校验提升熟悉度',
      hintKeepReviewing: '按保鲜预期巩固即可保持档位',
      evUnsure: '不确定申报',
      hoverOpenNode: '点击打开这篇知识页面',
      tierNodeTip: '有效熟悉度 {p}% · 证据 {n} 条 · 点击打开',
      tlNodeChipTip: '筛选该节点的 {n} 条学习事件',
      evidenceSourceTip: '查看这道校验题的证据来源文档',
      constellationTitle: '知识星图',
      constellationLit: '已覆盖',
      constellationHint: '越靠内环熟悉越深 · 圆点越大证据越多 · 虚线描边=证据不足 · 琥珀色=已淡化 · 闪烁=近 48 小时接触过 · 点击节点打开页面',
      constellationHoverP: '有效熟悉度 {p}%',
      constellationHoverN: '学习证据 {n} 条',
      quizLoadFailed: '取题失败，请稍后重试',
      loadError: '学习数据加载失败，请检查服务后重试',
      retry: '重试',
      collectKeptNote: '停采只是不再新增；已有 {n} 条记录仍保留，可随时导出或删除',
      deleteIrreversible: '我了解此操作不可撤销',
      loadFailed: '加载学习数据失败',
      submitFailed: '提交答案失败',
      exportFailed: '导出画像失败',
      deleteDone: '画像已删除',
      deleteFailed: '删除画像失败',
      toggleFailed: '设置失败，已回滚',
      answerCorrect: '回答正确',
      answerWrong: '回答错误',
      timelineTitle: '学习轨迹',
      selfAssessSection: '认为这个熟悉度判断不准？',
      selfAssessUp: '我更熟悉此知识',
      selfAssessDown: '我对此知识已生疏',
      selfAssessUpDone: '已把分数抬到「已验证」区间；通过 1 道解锁「熟悉」，隔天再通过 1 道正式解锁「已验证」',
      selfAssessDownDone: '已按你选择的原因调整熟悉度',
      selfAssessFailed: '自主认定提交失败，请重试',
      selfAssessDialogTitle: '哪方面不熟悉？',
      selfAssessSubmit: '提交自主认定',
      saReasonAll: '全部不熟（之前误触）',
      saReasonAllHint: '将该知识的熟悉度重置为零，重新建立覆盖',
      saReasonDocGap: '文档不涉及此方面',
      saReasonDocGapHint: '降一档，并记录"文档覆盖缺口"供知识库维护参考',
      saReasonDocUpdated: '文档更新了新内容待学',
      saReasonDocUpdatedHint: '降一档，并记录"知识已过期"供知识库维护参考',
      saReasonQuizEasy: '题目太简单导致虚高',
      saReasonQuizEasyHint: '降一档，并记录"题目效度问题"供题库维护参考',
      saBadgeUp: '自主认定：更熟（待校验——通过 1 道新题解锁「熟悉」，隔天再 1 道解锁「已验证」）',
      saBadgeDownAll: '自主认定：生疏（已重置）',
      saBadgeDownDocGap: '自主认定：生疏（文档不涉及）',
      saBadgeDownDocUpdated: '自主认定：生疏（文档已更新）',
      saBadgeDownQuizEasy: '自主认定：生疏（题目太简单）',
      evSelfAssessUp: '自主认定更熟',
      evSelfAssessDownAll: '自主认定重置',
      evSelfAssessDownDocGap: '自主认定降档·文档缺口',
      evSelfAssessDownDocUpdated: '自主认定降档·文档更新',
      evSelfAssessDownQuizEasy: '自主认定降档·题目效度',
      timelineTodayCount: '今日 {n} 条学习记录',
      timelineEmpty: '还没有学习事件',
      evCite: '问答引用',
      evCross: '跨题回访',
      evReAsk: '重复追问',
      evTopic: '话题投射',
      ...
      evQuizBad: '校验未过',
      evBackfill: '历史回填',
      profileScopeNote: '以下操作覆盖你在全部知识库的学习画像（非仅当前库）',
      tlMoreNodes: '展开全部 {n} 个节点',
      tlFewerNodes: '收起',
      profileTitle: '画像管理',
      stopCollect: '停止采集我的熟悉度数据',
      export: '导出画像',
      delete: '删除画像',
      deleteConfirmTitle: '删除学习画像',
      deleteConfirmBody: '将删除你的全部学习事件、熟悉度、话题映射与作答记录（题库保留）。此操作不可撤销。',
      // ---- 知识健康（owner/admin 组织视角）与岗位覆盖计划 ----
      viewPersonal: '个人视图',
      viewHealth: '知识健康',
      healthTitle: '知识资产健康',
      healthLoadFailed: '健康数据加载失败',
      healthSummaryNodes: '{total} 个知识节点',
      healthSummaryCovered: '{n} 个已覆盖',
      healthSummarySubjects: '{n} 人有学习记录',
      healthFoldersTitle: '目录覆盖度',
      healthFolderCovered: '{covered}/{total}',
      healthExpertsTitle: '专家分布（按熟悉人数）',
      healthExpertCount: '{n} 人熟悉',
      healthRisksTitle: '知识风险',
      riskSinglePoint: '单点知识：仅 1 人熟悉',
      riskStaleDoc: '文档知识已遗忘：曾被学习过，当前全员熟悉度已衰减',
      healthMaintenanceTitle: '治理收件箱',
      maintPendingVerify: '待验证的自主认定',
      maintDownAll: '自主认定：已重置',
      maintDocGap: '文档覆盖缺口',
      maintDocUpdated: '知识已过期（文档更新）',
      maintQuizEasy: '校验题效度存疑（题目太简单）',
      maintLatestAt: '最近 {t}',
      maintEmpty: '暂无维护标记',
      risksEmpty: '暂无风险',
      expertsEmpty: '暂无熟悉记录',
      rolePlanTitle: '岗位覆盖计划',
      rolePlanIntro: '按目录分组的覆盖建议——优先补齐你职责范围内未覆盖与待巩固的知识',
    },
    titleCreate: '新建知识库',
    titleEdit: '知识库设置',
    advanced: {
    ...
    wikiBrowser: {
      ...
      mcSummary: '有效熟悉度 {p}% · 证据 {n} 条',
      mcLastTouch: '最近触达',
      mcOpenNode: '点击节点打开知识页面',
      mcQuizN: '可用测验 {n} 题',
      mcLowConf: '证据不足（少于 3 条），档位仅供参考',
      masteryLegendNew: 'NEW=本次会话新点亮',
      masteryNoRing: '无环 · 未覆盖',
      masteryLowConfBadge: '低置信（虚线环）',
      masteryUnseen: '已淡化（有学习记录）',
      masteryTouched: '已接触',
      masteryFamiliar: '熟悉',
      masteryMastered: '已验证',
      ...
      issueGoFix: '去处理',
      assistantName: '知识助手',
      assistantNewChat: '开启新对话',
      assistantTitle: 'WeKnora 知识助手',
      assistantSceneWikiPage: '当前界面：知识节点「{title}」解析页',
      assistantSceneWiki: '当前界面：Wiki 知识网络',
      assistantSceneLearning: '当前界面：学习标签页 · 知识星图',
      assistantSceneDocuments: '当前界面：知识库文档',
      assistantSceneKb: '当前界面：知识库',
      assistantTooltip: '问问知识助手',
      assistantRetry: '会话创建失败，点击重试',
