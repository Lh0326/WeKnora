export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      howComputedGate: '升档需要直接证据：阅读与引用最高只能覆盖到「已接触」；通过 1 道新校验题解锁「熟悉」；隔天（间隔 ≥48 小时）再通过 1 道新题解锁「已验证」。',
      ...
      reasonSelfVerify: '自主认定待确认：你刚标记过此知识，请完成一组校验',
      changesTitle: '遗忘动态',
