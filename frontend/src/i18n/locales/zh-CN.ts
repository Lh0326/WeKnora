export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      tlToday: '今天',
      tlYesterday: '昨天',
      reAskHint: '此节点可能尚未真正理解，建议阅读 Wiki 页面或做一组测验',
      ...
      explainThresholds: "点亮需 ≥22%，较熟悉 ≥55%，已掌握 ≥80%",
      ...
      tierHintFamiliar: '有效掌握度 ≥ 55%',
      tierHintMastered: '有效掌握度 ≥ 80%',
