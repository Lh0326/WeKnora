export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      title: 'Knowledge network progress',
      litOf: '{lit} of {total} nodes lit',
      noNodes: 'Knowledge network not generated yet — build pages in the graph first',
      unitsTitle: 'By folder',
      rootUnit: 'Root',
      masteredOf: '{n} mastered',
      practiceN: 'Practice · {n} Qs',
      levelKeep: 'Current tier: {level} · effective mastery {p}%',
      levelUpdate: 'Mastery: {from} → {to}',
      optedOutNote: 'Collection is off: this answer is not recorded and mastery stays unchanged',
      collectOnNote: 'Collection is off: Q&A and quizzes no longer produce learning events',
      ...
      reAskHint: 'This node may not be fully understood yet: verify by reading the wiki page or taking the quiz',
      ...
      tierUnseen: 'Unseen',
      tierFaded: "Faded",
      explainTitle: "Why this tier?",
      explainPEff: "Effective mastery {p}% (after time decay)",
      explainThresholds: "Lit at ≥30%, Familiar ≥55%, Mastered ≥80%",
      explainEvidence: "Evidence: {pos} positive · {neg} negative",
      explainFaded: "You studied this node before, but wrong answers and repeat re-asks lowered the score and it decayed below the lit line — one correct quiz round pulls it back quickly",
      explainImprove: "To improve: correct quiz answer +2.2 · next-day read +0.5 · cross-question revisit +1.6",
      tierTouched: 'Touched',
      tierFamiliar: 'Familiar',
      tierMastered: 'Mastered',
      tierHintUnseen: 'No learning evidence yet',
      tierHintTouched: 'Effective mastery ≥ 30% (counted as lit)',
      tierHintFamiliar: 'Effective mastery ≥ 55%, plus a correct quiz answer',
      tierHintMastered: 'Effective mastery ≥ 80%, plus 2 distinct quiz items answered correctly on different days',
      howComputedTitle: 'How progress is computed',
      howComputedSignals: 'Cited answers, page reads and quiz attempts all accumulate mastery evidence on the nodes they hit: answer citation +1.0, page read +0.5 (every open is traced in the timeline; the score counts once per 48h), cross-question revisit +1.6, quiz correct +2.2, quiz wrong -1.5, repeat re-ask -0.8, topic signal +0.5.',
      howComputedGate: 'Promotion needs direct evidence: reads and citations cap at Touched; 1 correct answer on a new quiz item unlocks Familiar; another new item ≥48h later unlocks Mastered.',
      howComputedDecay: 'Evidence decays over time: without review, effective mastery gradually falls back.',
      howComputedTiers: 'Tiers follow effective mastery: Touched ≥ 30% (lit), Familiar ≥ 55%, Mastered ≥ 80%.',
      evidenceRefs: 'Based on {n} source passages',
      recommendTitle: 'What to look at next',
      recommendEmpty: 'No recommendations',
      reasonAffinity: 'Your frequently used documents touch this node',
      reasonFrontier: 'The next step on your knowledge frontier',
      reasonConsolidate: 'Consolidate a touched edge',
      reasonReview: 'Due for review: mastery is fading',
      reasonRemedial: 'Mistake drill: previously answered wrong',
      reasonStruggling: 'Repeated re-asks: this node keeps being re-asked',
      ...
      inGraph: "Graph",
      practice: 'Practice',
      quizTitle: 'Practice: {slug}',
      quizEmpty: 'No questions for this node yet',
      submitAnswer: 'Submit',
      nextQuestion: 'Next question',
      evidenceSource: 'Evidence',
      nextReviewDays: 'Review plan: this node should hold for about {n} days',
      reviewNow: 'Review plan: consolidate this node soon',
      ...
      pEffMove: 'Effective mastery {from}% → {to}%',
      progressZoneTitle: 'My progress',
      todayAnswers: 'Today: {n} answers · {m} correct',
      todayLit: '{n} nodes lit today',
      todayEvents: 'Today: {n} events',
      todayEventsNote: 'Learning events recorded today: page reads, answer citations, quiz attempts and self-assessments',
      todayCardTitle: 'To consolidate today',
      todoDemoted: 'Demoted · review',
      todoDue: 'Due soon',
      reasonRemedialShort: 'Re-drill',
      reasonStrugglingShort: 'Re-asked',
      reasonStuckShort: 'Prereq stuck',
      hintFirstTouch: 'Read the page or ask a question to light it',
      hintQuizUnlockFamiliar: 'Answer 1 new quiz item correctly to unlock Familiar',
      hintQuizUnlockMastered: 'Answer another new item on a later day to unlock Mastered',
      hintGrowMastery: 'Keep answering quizzes to raise mastery',
      hintKeepReviewing: 'Follow the review schedule to keep the tier',
      evUnsure: 'Unsure declaration',
      hoverOpenNode: 'Open this knowledge page',
      tierNodeTip: 'Effective mastery {p}% · {n} evidence · click to open',
      tlNodeChipTip: 'Filter this node’s {n} learning events',
      evidenceSourceTip: 'Open the source document behind this question',
      constellationTitle: 'Knowledge constellation',
      constellationLit: 'lit',
      constellationHint: 'Inner rings = deeper mastery · larger dots = more evidence · dashed = low confidence · amber = faded · twinkling = studied within 48h · click a node to open',
      constellationHoverP: 'Effective mastery {p}%',
      ...
      timelineTitle: 'Lighting timeline',
      selfAssessSection: 'Think this rating is off?',
      selfAssessUp: 'I know this better',
      selfAssessDown: 'I know this less',
      selfAssessUpDone: 'Score lifted into the mastered band; 1 correct answer unlocks Familiar, another one a day later unlocks Mastered',
      selfAssessDownDone: 'Mastery adjusted per your chosen reason',
      selfAssessFailed: 'Failed to submit self-assessment, please retry',
      selfAssessDialogTitle: 'Which part are you less proficient at?',
      selfAssessSubmit: 'Submit',
      saReasonAll: 'Not proficient at all (mis-clicked before)',
      saReasonAllHint: 'Reset this node mastery score to zero',
      ...
      saBadgeUp: 'Self-assessed: better (awaiting quiz proof)',
      saBadgeDownAll: 'Self-assessed: reset',
      saBadgeDownDocGap: 'Self-assessed: less (doc gap)',
      saBadgeDownDocUpdated: 'Self-assessed: less (docs updated)',
      saBadgeDownQuizEasy: 'Self-assessed: less (quiz too easy)',
      evSelfAssessUp: 'Self-assess up',
      evSelfAssessDownAll: 'Self-assess reset',
      evSelfAssessDownDocGap: 'Self-assess demote: doc gap',
      evSelfAssessDownDocUpdated: 'Self-assess demote: docs updated',
      evSelfAssessDownQuizEasy: 'Self-assess demote: quiz validity',
      ...
      evRead: 'Page read',
      evQuizOk: 'Quiz correct',
      evQuizBad: 'Quiz wrong',
      ...
      stopCollect: 'Stop collecting my learning data',
      export: 'Export profile',
      delete: 'Delete profile',
      deleteConfirmTitle: 'Delete learning profile',
      deleteConfirmBody: 'This deletes all your learning events, mastery states, topic mappings and quiz attempts (the shared question bank stays). This cannot be undone.',
    },
    activity: {
      title: 'Activity',
