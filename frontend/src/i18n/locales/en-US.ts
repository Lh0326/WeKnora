export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      reAskHint: 'This node may not be fully understood yet - reading the wiki page or taking the quiz helps',
      ...
      explainThresholds: "Lit at ≥22%, Familiar ≥55%, Mastered ≥80%",
      ...
      tierHintFamiliar: 'Effective mastery ≥ 55%',
      tierHintMastered: 'Effective mastery ≥ 80%',
      ...
      recommendEmpty: 'No recommendations yet — ask some questions first',
      ...
      reasonRemedial: 'Mistake drill: you failed this before — try again',
      reasonStruggling: 'Repeated re-asks: this one may never have landed — worth a drill',
      ...
      changesIdle: 'idle {d} days · review soon',
      ...
      kbdHint: 'A–D to choose · Enter to submit',
