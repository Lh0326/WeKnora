export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      zoneIntro: 'Start with the "Start here" module and work down: finish ① and ② takes over; the top-right number = lit/total ("already mastered, stop suggesting" counts as lit)',
