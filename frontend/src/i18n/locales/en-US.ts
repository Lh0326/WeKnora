export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      howComputedGate: 'Promotion needs direct evidence: reads and citations cap at Touched; passing 1 new check item unlocks Familiar; another new item ≥48h later unlocks Verified.',
      ...
      reasonSelfVerify: 'Self-attestation pending: you just flagged this knowledge — confirm with a check',
      ...
      saBadgeUp: 'Self-attested: better (awaiting check confirmation)',
