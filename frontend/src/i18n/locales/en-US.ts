export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      title: 'Knowledge network coverage and guidance',
      litOf: '{lit} of {total} nodes covered',
      noNodes: 'Knowledge network not generated yet — build pages in the graph first',
      goGraph: 'Open the graph',
      lowConfidenceTip: 'Fewer than 3 evidence items — tier is provisional',
      tlFilteredEmpty: 'No match within the records loaded so far',
      tlLoadMore: 'Load more',
      constellationMore: '{n} more low-signal nodes not shown',
      unitsTitle: 'By folder',
      rootUnit: 'Root',
      masteredOf: '{n} verified',
      practiceN: 'Knowledge check · {n} Qs',
      levelKeep: 'Current tier: {level} · effective familiarity {p}%',
      levelUpdate: 'Familiarity: {from} → {to}',
      optedOutNote: 'Collection is off: this answer is not recorded and familiarity stays unchanged',
      collectOnNote: 'Collection is off: Q&A and knowledge checks no longer produce learning events',
      profileSummary: '{nodes} nodes · {events} learning events · last activity {last}',
      tierListEmpty: 'No nodes in this tier yet',
      tlFilterAll: 'All',
      tlFilterCite: 'Q&A',
      tlFilterCross: 'Cross-ref',
      tlFilterReAsk: 'Re-ask',
      tlFilterQuiz: 'Check',
      tlToday: 'Today',
      tlYesterday: 'Yesterday',
      reAskHint: 'This knowledge may not be fully understood yet: verify by reading the wiki page or running a knowledge check',
      deleteAlsoOptOut: 'Also stop collection (no new data after deletion)',
      badgeEntity: 'Entity',
      timelineEnd: 'End of timeline · {n} events in total',
      badgeConcept: 'Concept',
      tierUnseen: 'Uncovered',
      tierFaded: "Faded",
      explainTitle: "Why this familiarity tier?",
      explainPEff: "Effective familiarity {p}% (after time decay)",
      explainThresholds: "Covered at ≥30%, Familiar ≥55%, Verified ≥80%",
      explainEvidence: "Evidence: {pos} positive · {neg} negative",
      explainFaded: "You have touched this knowledge before, but failed checks and repeat re-asks lowered the score and it decayed back below the coverage line — passing one round of checks pulls it back quickly",
      explainImprove: "To improve: passed check +2.2 · next-day read +0.5 · cross-question revisit +1.6",
      tierTouched: 'Touched',
      tierFamiliar: 'Familiar',
      tierMastered: 'Verified',
      tierHintUnseen: 'No learning evidence yet',
      tierHintTouched: 'Effective familiarity ≥ 30% (counted as covered)',
      tierHintFamiliar: 'Effective familiarity ≥ 55%, plus a passed check',
      tierHintMastered: 'Effective familiarity ≥ 80%, plus 2 distinct check items passed on different days',
      howComputedTitle: 'How progress is computed',
      howComputedSignals: 'Cited answers, page reads and knowledge checks all accumulate familiarity evidence on the nodes they hit: answer citation +1.0, page read +0.5 (every open is traced in the learning trail; the score counts once per 48h), cross-question revisit +1.6, check passed +2.2, check failed -1.5, repeat re-ask -0.8, topic signal +0.5.',
      howComputedGate: 'Promotion needs direct evidence: reads and citations cap at Touched. Independently passing one item unlocks Familiar. Passing at least two different items with successful independent checks ≥48h apart unlocks Verified. Same-item retries within 48h of feedback give explanations but no additional ability evidence.',
      howComputedDecay: 'Evidence decays over time: without consolidation, effective familiarity gradually falls back.',
      howComputedTiers: 'Tiers follow effective familiarity: Touched ≥ 30% (covered), Familiar ≥ 55%, Verified ≥ 80%.',
      evidenceRefs: 'Based on {n} source passages',
      recommendTitle: 'Coverage suggestions',
      rsAffinity: 'Related',
      rsFrontier: 'Next up',
      rsFoundation: 'Start here',
      rsContinue: 'Keep going',
      rsConsolidate: 'Solidify',
      rsReview: 'A while ago',
      rsRemedial: 'Try again',
      rsStruggling: 'Take another look',
      rsStuck: 'Prereq first',
      rsBypass: 'Detour',
      rsExplore: 'Mix it up',
      rsSelfVerify: 'Your call',
      recommendEmpty: 'No recommendations',
      zoneStartHere: 'Start here',
      zoneCountTip: '{lit} of {total} lit ("already mastered, stop suggesting" counts as lit)',
      zoneThenNote: 'takes over after ①',
      zoneActionsBtn: 'Self-assess / mastered',
      zoneHintUnseen: 'Open and read to light it up; it stays at ① after reading until a quiz lifts its tier',
      zoneHintTouched: 'Already read — take the quiz on its page to reach Familiar',
      zoneHintFamiliar: 'Doing well — pass 2 different quizzes on a later day to become Verified',
      zoneHintFaded: 'Learned before but faded; a quick quiz brings it back',
      zoneQuizAvail: '{n} quiz question(s) ready',
      objProgressVerified: 'Verified {v}/{t} learning objectives',
      objProgressConflicting: ', {n} conflicting (re-verification owed)',
      objProgressStale: ', {n} stale (content re-versioned)',
      objProgressPartial: ', {n} partial (one family passed)',
      objProgressUntested: ', {n} untested',
      objProgressContact: 'Contacted {c}/{n} nodes (contact ≠ verified)',
      objProgressSelfReport: '{n} self-reported (pending verification)',
      pathTitle: 'Learning Path',
      pathEmpty: 'No recommended path yet — set a learning goal to get one',
      pathMinutes: 'min',
      pathRequires: 'Prerequisite',
      pathActOverview: 'Overview',
      pathActRead: 'Read',
      pathActBridge: 'Bridge',
      pathActPractice: 'Practice',
      pathActVerify: 'Verify',
      pathActReview: 'Review',
      pathWhyFirstContact: 'First contact with this knowledge — read to build awareness',
      pathWhyPractice: 'Contacted but unverified — practice before challenging',
      pathWhyVerify: 'Foundation in place — complete the verification contract',
      pathWhyBridge: 'Patch the prerequisite first',
      pathWhyBridgeFail: 'Repeated failures — bridge with a different approach',
      pathWhyReview: 'Verified but time has passed — review to confirm',
      pathWhySuccessor: 'Prerequisite verified — advance to the next stage',
      pathWhyContinue: 'Continuing your recent learning thread',
      pathWhyFastTrack: 'Fast-track challenge — verify what you already know',
      pathWhyFallback: 'Start from the earliest unvisited node',
      pathDegradeNoContent: 'No knowledge content yet — upload documents and generate Wiki first',
      pathDegradeOrientation: 'Starting with the earliest uncontacted node',
      objProgressGoalScope: 'Selected goals: verified {v}/{t} (removing goals does not inflate library coverage)',
      pathActionEnter: 'Start',
      pathActionChallenge: 'Challenge',
      pathActionDisagree: 'Disagree',
      nodeContactedYes: 'Contacted',
      nodeContactedNo: 'Not contacted',
      nodeSelfUp: 'Self: more familiar',
      nodeSelfDown: 'Self: less familiar',
      nodeLastVerified: 'Last verified',
      nodeNextVerified: 'Next: advance to successors',
      nodeNextConflicting: 'Next: complete a new verification round',
      nodeNextStale: 'Next: re-verify against new content',
      nodeNextPartial: 'Next: pass a second family',
      nodeNextUnverified: 'Next: read + practice + verify',
      nodeNextRetired: 'Skipped (can restore)',
      nodeNextChallenge: 'Challenge pending',
      pathActionSwitchMaterial: 'Switch material',
      pathActionViewEvidence: 'View evidence',
      pathActionExport: 'Export profile',
      pathActionDelete: 'Delete profile',
      zonePathCaption: 'Learning path (shallow to deep; click any node to study it)',
      zonePathLegend: "The colored badge on the right = that node's tier and effective familiarity",
      zoneExpandPath: 'Expand path ({n} stops)',
      zoneCollapsePath: 'Collapse path',
      zoneCurrentMark: 'current',
      reasonAffinity: 'Your frequently used documents touch this knowledge',
      reasonFrontier: 'The next step on your knowledge frontier',
      reasonConsolidate: 'Consolidate a touched edge',
      reasonReview: 'Due for consolidation: familiarity is fading',
      reasonRemedial: 'Re-check: this knowledge previously failed a check',
      reasonStruggling: 'Repeated re-asks: this knowledge keeps being re-asked',
      reasonStuck: 'A prerequisite has stayed unverified for long; shore it up first',
      reasonBypass: 'Target blocked by a prerequisite — try a neighbor first',
      reasonExplore: 'Exploring a blind spot',
      reasonSelfVerify: 'Self-attestation pending: pass 1 new item to unlock Familiar, another one a day later to unlock Verified',
      reasonFoundation: 'Starting point: opens the source material — the first stop when starting from zero',
      reasonContinue: 'Continues: next after what you just learned',
      zoneIntro: 'Follow the "current" marker: it advances along the path as you consolidate; expand to review the whole route. Top-right = lit/total ("already mastered, stop suggesting" counts as lit)',
      zoneDone: 'Module fully lit',
      zoneNextMark: "This module's first step",
      constellationHint3d: 'Inner rings = verified · sectors = modules · hover for relations · wheel zoom · drag to orbit · double-click reset',
      constellationDustHint: '{n} unvisited nodes — click to expand',
      whyFirstStop: 'The opening stop — build the big picture here',
      whyMaterialStart: 'Position #{rank} in the material — opening node of "{section}"',
      whyContinuesPrereq: 'Builds on what you just learned: "{ref}" — its natural next step',
      whyContinuesPrev: 'Follows the previous pick "{ref}" — one step after another',
      whySameSection: 'Same chapter "{section}" as "{ref}" you just learned — learn it next',
      whyChapterOf: 'Belongs to "{label}"',
      whyInDoc: 'From "{label}"',
      skipAction: 'Already mastered — hide from queue',
      skipNote: '“Already mastered — hide from queue”: hidden nodes leave “What to look at next” and the forgetting digest; restore anytime from the tier list',
      skipDone: 'Removed the node from the recommendation queue',
      skipRestored: 'Restored to recommendations',
      skipFailed: 'Operation failed, please retry',
      skippedTag: 'Skipped',
      skippedBadge: 'Skipped: self-declared mastered (click to open and learn anytime; restore from the tier list)',
      restoreSkip: 'Restore',
      selfVerifyGoVerify: 'Finish the check',
      selfVerifyQuizPending: 'Check items are being generated — read the page first; once items are ready, passing 1 unlocks Familiar',
      recommendOrderIntro: 'Ordered shallow → deep through the material: start at #1 and work down; the folder tag is provenance only',
      recommendStartHere: 'Start here',
      explainDocRank: 'Material position: #{n} (1 = the opening; recommendations follow this order)',
      explainSource: 'Source: "{section}" — {doc}',
      selfAssessUpDoneNoQuiz: 'Score lifted; once check items are generated, passing 1 unlocks Familiar',
      tierListLoadFailed: 'Failed to load the node list',
      changesIdle: 'idle {d} days',
      changesNext: 'demotes in ~{n} days',
      openPage: 'Open',
      practice: 'Knowledge check',
      quizTitle: 'Knowledge check: {slug}',
      quizEmpty: 'No check items for this knowledge yet',
      submitAnswer: 'Submit',
      nextQuestion: 'Next question',
      evidenceSource: 'Evidence',
      nextReviewDays: 'Freshness outlook: this knowledge should hold for about {n} days',
      reviewNow: 'Freshness outlook: run a check on this knowledge soon',
      kbdHint: 'A–D to choose · E unsure · Enter to submit',
      unsureOption: 'Not sure — show me the explanation',
      answerUnsure: 'You chose “not sure”',
      unsureNote: 'Answering unsure neither scores nor penalizes: read the explanation below and answer again another day.',
      pEffMove: 'Effective familiarity {from}% → {to}%',
      todayAnswers: 'Today: {n} checks · {m} passed',
      todayLit: '{n} nodes covered today',
      todayEvents: 'Today: {n} events',
      todayEventsNote: 'Learning events recorded today: page reads, answer citations, knowledge checks and self-attestations',
      todayCardTitle: 'To consolidate today',
      todoDemoted: 'Demoted · consolidate',
      todoDue: 'Due soon',
      reasonRemedialShort: 'Re-check',
      reasonStrugglingShort: 'Re-asked',
      reasonStuckShort: 'Prereq unverified',
      hintFirstTouch: 'Read the page or ask a question to cover it',
      hintQuizUnlockFamiliar: 'Pass 1 new check item to unlock Familiar',
      hintQuizUnlockMastered: 'Pass another new item on a later day to unlock Verified',
      hintGrowMastery: 'Keep passing checks to raise familiarity',
      hintKeepReviewing: 'Follow the freshness outlook to keep the tier',
      evUnsure: 'Unsure declaration',
      hoverOpenNode: 'Open this knowledge page',
      tierNodeTip: 'Effective familiarity {p}% · {n} evidence · click to open',
      tlNodeChipTip: 'Filter this node’s {n} learning events',
      evidenceSourceTip: 'Open the source document behind this check item',
      constellationTitle: 'Knowledge constellation',
      constellationLit: 'covered',
      constellationHint: 'Inner rings = deeper familiarity · larger dots = more evidence · dashed = low confidence · amber = faded · twinkling = touched within 48h · click a node to open',
      constellationHoverP: 'Effective familiarity {p}%',
      constellationHoverN: '{n} evidence items',
      quizLoadFailed: 'Failed to load questions, try again later',
      loadError: 'Failed to load learning data — check the service and retry',
      retry: 'Retry',
      collectKeptNote: 'Pausing only stops new records; your existing {n} records stay and can be exported or deleted anytime',
      deleteIrreversible: 'I understand this action cannot be undone',
      ...
      toggleFailed: 'Setting failed, reverted',
      answerCorrect: 'Correct',
      answerWrong: 'Wrong answer',
      timelineTitle: 'Learning trail',
      selfAssessSection: 'Think this familiarity rating is off?',
      selfAssessUp: 'I know this knowledge better',
      selfAssessDown: 'I have grown rusty on this knowledge',
      selfAssessUpDone: 'Score lifted into the verified band; 1 passed check unlocks Familiar, another one a day later formally unlocks Verified',
      selfAssessDownDone: 'Familiarity adjusted per your chosen reason',
      selfAssessFailed: 'Failed to submit self-attestation, please retry',
      selfAssessDialogTitle: 'Which part are you less familiar with?',
      selfAssessSubmit: 'Submit',
      saReasonAll: 'Not proficient at all (mis-clicked before)',
      saReasonAllHint: 'Reset the familiarity of this knowledge to zero and rebuild coverage',
      saReasonDocGap: 'Docs do not cover this part',
      saReasonDocGapHint: 'Demote one band and record a doc-coverage gap for maintenance',
      saReasonDocUpdated: 'Docs gained new content to learn',
      saReasonDocUpdatedHint: 'Demote one band and record stale knowledge for maintenance',
      saReasonQuizEasy: 'Quiz was too easy',
      saReasonQuizEasyHint: 'Demote one band and record a quiz-validity issue for maintenance',
      saBadgeUp: 'Self-attested: better (awaiting check — pass 1 new item to unlock Familiar, another a day later to unlock Verified)',
      saBadgeDownAll: 'Self-attested: reset',
      saBadgeDownDocGap: 'Self-attested: rusty (doc gap)',
      saBadgeDownDocUpdated: 'Self-attested: rusty (docs updated)',
      saBadgeDownQuizEasy: 'Self-attested: rusty (quiz too easy)',
      evSelfAssessUp: 'Self-attestation up',
      evSelfAssessDownAll: 'Self-attestation reset',
      evSelfAssessDownDocGap: 'Self-attestation demote: doc gap',
      evSelfAssessDownDocUpdated: 'Self-attestation demote: docs updated',
      evSelfAssessDownQuizEasy: 'Self-attestation demote: quiz validity',
      timelineTodayCount: 'Today: {n} learning events',
      timelineEmpty: 'No learning events yet',
      evCite: 'Cited',
      evCross: 'Revisit',
      evReAsk: 'Re-asked',
      evTopic: 'Topic signal',
      evDeepRead: 'Deep read',
      evRead: 'Page read',

      evAgentRead: 'Assistant lookup',
      evQuizOk: 'Check passed',
      evQuizBad: 'Check failed',
      evBackfill: 'Backfilled',
      profileScopeNote: 'These actions cover your learning profile across ALL knowledge bases',
      tlMoreNodes: 'Show all {n} nodes',
      tlFewerNodes: 'Show fewer',
      profileTitle: 'Profile management',
      stopCollect: 'Stop collecting my familiarity data',
      export: 'Export profile',
      delete: 'Delete profile',
      deleteConfirmTitle: 'Delete learning profile',
      deleteConfirmBody: 'This deletes all your learning events, familiarity states, topic mappings and check attempts (the shared question bank stays). This cannot be undone.',
      // ---- knowledge health (owner/admin org view) & role coverage plan ----
      viewPersonal: 'Personal view',
      viewHealth: 'Knowledge health',
      healthTitle: 'Knowledge asset health',
      healthLoadFailed: 'Failed to load health data',
      healthSummaryNodes: '{total} knowledge nodes',
      healthSummaryCovered: '{n} covered',
      healthSummarySubjects: '{n} people with learning records',
      healthFoldersTitle: 'Folder coverage',
      healthFolderCovered: '{covered}/{total}',
      healthExpertsTitle: 'Expert distribution (by familiar people)',
      healthExpertCount: '{n} familiar',
      healthRisksTitle: 'Knowledge risks',
      riskSinglePoint: 'Single-point knowledge: only 1 person is familiar',
      riskStaleDoc: 'Forgotten document knowledge: it was learned before, but everyone’s familiarity has since decayed',
      healthMaintenanceTitle: 'Governance inbox',
      maintPendingVerify: 'Self-attestations pending verification',
      maintDownAll: 'Self-attestation: reset',
      maintDocGap: 'Document coverage gap',
      maintDocUpdated: 'Knowledge outdated (document updated)',
      maintQuizEasy: 'Check-item validity in doubt (questions too easy)',
      maintLatestAt: 'Latest {t}',
      maintEmpty: 'No maintenance marks',
      risksEmpty: 'No risks',
      expertsEmpty: 'No familiarity records',
      rolePlanTitle: 'Role coverage plan',
      rolePlanIntro: 'Coverage suggestions grouped by folder — close the uncovered and due-for-consolidation knowledge within your responsibilities first',
    },
    activity: {
      title: 'Activity',
    ...
    wikiBrowser: {
      ...
      mcSummary: 'Effective familiarity {p}% · {n} evidence items',
      mcLastTouch: 'Last touched',
      mcOpenNode: 'Click the node to open the page',
      mcQuizN: '{n} quiz questions available',
      mcLowConf: 'Insufficient evidence (<3) — tier is provisional',
      masteryLegendNew: 'NEW = newly lit this session',
      masteryNoRing: 'No ring · not covered',
      masteryLowConfBadge: 'Low confidence (dashed ring)',
      masteryUnseen: 'Faded (has history)',
      masteryTouched: 'Touched',
      masteryFamiliar: 'Familiar',
      masteryMastered: 'Verified',
      ...
      assistantTitle: 'WeKnora Assistant',
      assistantSceneWikiPage: 'You are on: wiki page “{title}”',
      assistantSceneWiki: 'You are on: wiki knowledge map',
      assistantSceneLearning: 'You are on: learning tab · constellation',
      assistantSceneDocuments: 'You are on: knowledge documents',
      assistantSceneKb: 'You are on: this knowledge base',
      assistantTooltip: 'Ask the knowledge assistant',
      assistantRetry: 'Session failed to start — click to retry',
  ...
  error: {
    ...
    streamInterrupted: 'The previous reply was interrupted (service restart or expired stream). Please send your question again',
    auth: {
