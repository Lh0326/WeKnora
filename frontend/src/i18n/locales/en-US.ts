export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      zoneIntro: 'Each module recommends its own next step; hover to highlight it in the map',
    ...
    wikiBrowser: {
      ...
      mcSummary: 'Mastery {p}% · {n} evidence items',
      ...
      masteryNoRing: 'No ring · never touched',
      masteryLowConfBadge: 'Low confidence (dashed ring)',
      masteryUnseen: 'Unseen (has history)',
