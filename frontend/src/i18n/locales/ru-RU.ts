export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      title: 'Прогресс по сети знаний',
      litOf: 'Освещено узлов: {lit} из {total}',
      noNodes: 'Сеть знаний ещё не создана — сначала постройте страницы в графе',
      unitsTitle: 'По разделам',
      rootUnit: 'Корень',
      masteredOf: '{n} освоено',
      practiceN: 'Практика · {n} вопр.',
      levelKeep: 'Текущий уровень: {level} · эффективное усвоение {p}%',
      levelUpdate: 'Мастерство: {from} → {to}',
      optedOutNote: 'Сбор отключён: ответ не записывается, mastery не меняется',
      collectOnNote: 'Сбор отключён: вопросы и тесты больше не создают события обучения',
      ...
      tlToday: 'Сегодня',
      tlYesterday: 'Вчера',
      reAskHint: 'Этот узел может быть усвоен не до конца: проверьте себя, прочтя страницу Wiki или пройдя тест',
      ...
      tierUnseen: 'Не начато',
      tierFaded: "Угасло",
      explainTitle: "Почему такой уровень?",
      explainPEff: "Эффективное усвоение {p}% (с учётом угасания)",
      explainThresholds: "Подсветка при ≥30%, знакомо ≥55%, освоено ≥80%",
      explainEvidence: "Признаки: положительных {pos} · отрицательных {neg}",
      explainFaded: "Вы уже изучали этот узел, но ошибки и повторные вопросы снизили балл, и со временем он угас ниже линии подсветки — верный ответ на тест быстро вернёт его",
      explainImprove: "Как поднять: верный ответ +2.2 · чтение на следующий день +0.5 · возврат из другого вопроса +1.6",
      tierTouched: 'Затронуто',
      tierFamiliar: 'Знакомо',
      tierMastered: 'Освоено',
      tierHintUnseen: 'Пока нет признаков изучения',
      tierHintTouched: 'Эффективное освоение ≥ 30% (считается освещённым)',
      tierHintFamiliar: 'Эффективное освоение ≥ 55% плюс верный ответ на тест',
      tierHintMastered: 'Эффективное освоение ≥ 80% плюс 2 разных задания теста, решённых в разные дни',
      howComputedTitle: 'Как считается прогресс',
      howComputedSignals: 'Цитирование в ответах, чтение страниц и тесты накапливают признаки освоения: цитирование +1.0, чтение страницы +0.5 (каждое открытие попадает в ленту; балл — раз в 48ч), повторный заход +1.6, верный ответ +2.2, неверный -1.5, повторный вопрос -0.8, тематический сигнал +0.5.',
      howComputedGate: 'Повышение требует прямых признаков: чтение и цитирование дают не выше «Касались»; верный ответ на новое задание открывает «Знакомо»; ещё одно новое задание через ≥48 ч открывает «Освоено».',
      howComputedDecay: 'Признаки со временем затухают: без повторения эффективное освоение постепенно снижается.',
      howComputedTiers: 'Уровни по эффективному освоению: Затронуто ≥ 30% (освещён), Знакомо ≥ 55%, Освоено ≥ 80%.',
      evidenceRefs: 'На основе {n} фрагментов источника',
      recommendTitle: 'Что изучить дальше',
      recommendEmpty: 'Рекомендаций нет',
      reasonAffinity: 'Часто используемые вами документы касаются этого узла',
      reasonFrontier: 'Следующий шаг на границе знаний',
      reasonConsolidate: 'Закрепите затронутую тему',
      reasonReview: 'Пора повторить: усвоение угасает',
      reasonRemedial: 'Разбор ошибок: ранее допущена ошибка',
      reasonStruggling: 'Повторные переспросы: узел многократно переспрашивался',
      reasonStuck: 'Пререквизит долго не осваивается — начните с него',
      reasonBypass: 'Цель заблокирована пререквизитом — начните со соседней',
      reasonExplore: 'Исследование слепой зоны',
      reasonSelfVerify: 'Самопроверка: вы только что отметили этот узел — подтвердите тестом',
      ...
      inGraph: "Граф",
      practice: 'Тренировка',
      quizTitle: 'Тренировка: {slug}',
      quizEmpty: 'Для этого узла пока нет вопросов',
      submitAnswer: 'Ответить',
      nextQuestion: 'Следующий вопрос',
      evidenceSource: 'Источник',
      nextReviewDays: 'План повторения: узел продержится около {n} дн.',
      reviewNow: 'План повторения: скоро закрепите этот узел',
      ...
      pEffMove: 'Эффективное освоение {from}% → {to}%',
      progressZoneTitle: 'Мой прогресс',
      todayAnswers: 'Сегодня: {n} ответов · {m} верных',
      todayLit: 'Сегодня подсвечено узлов: {n}',
      todayEvents: 'Сегодня: {n} событий',
      todayEventsNote: 'События обучения за сегодня: чтение страниц, цитаты в ответах, тесты и самооценка',
      todayCardTitle: 'Закрепить сегодня',
      todoDemoted: 'Понижен · повторить',
      todoDue: 'Скоро понижение',
      reasonRemedialShort: 'Ошибки',
      reasonStrugglingShort: 'Переспрашиваете',
      reasonStuckShort: 'База не освоена',
      hintFirstTouch: 'Откройте страницу или задайте вопрос, чтобы подсветить',
      hintQuizUnlockFamiliar: 'Верный ответ на новое задание откроет «Знакомо»',
      hintQuizUnlockMastered: 'Ещё одно новое задание в другой день откроет «Освоено»',
      hintGrowMastery: 'Продолжайте верно отвечать, чтобы расти',
      hintKeepReviewing: 'Следуйте графику повторения, чтобы сохранить уровень',
      evUnsure: 'Признание «не уверен»',
      hoverOpenNode: 'Открыть эту страницу знаний',
      tierNodeTip: 'Эффективное освоение {p}% · признаков: {n} · нажмите, чтобы открыть',
      tlNodeChipTip: 'Показать {n} событий этого узла',
      evidenceSourceTip: 'Открыть документ-источник этого задания',
      constellationTitle: 'Созвездие знаний',
      constellationLit: 'подсвечено',
      constellationHint: 'Внутренние кольца = глубже освоение · крупнее точка = больше признаков · пунктир = мало данных · янтарный = затухает · мерцание = занимались за 48 ч · щёлкните узел, чтобы открыть',
      constellationHoverP: 'Эффективное освоение {p}%',
      ...
      selfAssessSection: 'Оценка кажется неточной?',
      selfAssessUp: 'Знаю лучше',
      selfAssessDown: 'Знаю хуже',
      selfAssessUpDone: 'Балл поднят до зоны освоения; 1 верный ответ открывает «Знаком», ещё один на следующий день — «Освоено»',
      selfAssessDownDone: 'Уровень скорректирован по выбранной причине',
      selfAssessFailed: 'Не удалось отправить самооценку, повторите',
      selfAssessDialogTitle: 'Какая часть слабее?',
      selfAssessSubmit: 'Отправить',
      saReasonAll: 'Совсем не владею (ранее промахнулся)',
      saReasonAllHint: 'Сбросить оценку освоения этого узла до нуля',
      ...
      saBadgeUp: 'Самооценка: выше (ждёт подтверждения тестом)',
      saBadgeDownAll: 'Самооценка: сброс',
      saBadgeDownDocGap: 'Самооценка: ниже (пробел в доках)',
      saBadgeDownDocUpdated: 'Самооценка: ниже (доки обновлены)',
      saBadgeDownQuizEasy: 'Самооценка: ниже (тест лёгкий)',
      evSelfAssessUp: 'Самооценка вверх',
      evSelfAssessDownAll: 'Самооценка: сброс',
      evSelfAssessDownDocGap: 'Понижение: пробел в доках',
      evSelfAssessDownDocUpdated: 'Понижение: доки обновлены',
      evSelfAssessDownQuizEasy: 'Понижение: валидность теста',
      ...
      evQuizOk: 'Верный ответ',
      evQuizBad: 'Неверный ответ',
      evBackfill: 'История',
      ...
      stopCollect: 'Не собирать мои данные обучения',
      export: 'Экспорт профиля',
      delete: 'Удалить профиль',
      deleteConfirmTitle: 'Удалить профиль обучения',
      deleteConfirmBody: 'Будут удалены все ваши события обучения, состояния освоения, привязки тем и попытки тестов (общий банк вопросов сохраняется). Действие необратимо.',
    },
