export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      zoneIntro: 'Каждый модуль рекомендует свой следующий шаг; наведите, чтобы подсветить его на карте',
    ...
    wikiBrowser: {
      ...
      mcSummary: 'Вероятность освоения {p}% · событий: {n}',
      ...
      masteryNoRing: 'Без кольца · не затронуто',
      masteryLowConfBadge: 'Низкая уверенность (пунктир)',
      masteryUnseen: 'Не освоено (есть история)',
