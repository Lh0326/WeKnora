export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      zoneIntro: 'Начните с модуля «Начните здесь» и двигайтесь вниз: после ① его место занимает ②; число справа сверху = освещено/всего («уже освоено, убрать» тоже считается)',
