export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      howComputedGate: 'Повышение требует прямых признаков: чтение и цитирование дают не выше «Затронуто»; пройденное новое задание проверки открывает «Знакомо»; ещё одно новое задание через ≥48 ч открывает «Подтверждено».',
      ...
      reasonSelfVerify: 'Самодекларация ждёт подтверждения: вы только что отметили эти знания — подтвердите проверкой',
      changesTitle: 'Динамика забывания',
      changesDemoted: 'узлов понижено из-за забывания: {n}',
      changesDue: 'узлов у порога понижения: {n}',
      ...
      progressZoneTitle: 'Мой прогресс',
      ...
      saBadgeUp: 'Самодекларация: выше (ждёт подтверждения проверкой)',
