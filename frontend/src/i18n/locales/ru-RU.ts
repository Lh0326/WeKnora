export default {
  ...
  knowledgeEditor: {
    learningTab: {
      ...
      tlToday: 'Сегодня',
      tlYesterday: 'Вчера',
      reAskHint: 'Этот узел может быть усвоен не до конца - прочтите страницу Wiki или пройдите тест',
      ...
      explainThresholds: "Подсветка при ≥22%, знакомо ≥55%, освоено ≥80%",
      ...
      tierHintFamiliar: 'Эффективное освоение ≥ 55%',
      tierHintMastered: 'Эффективное освоение ≥ 80%',
      ...
      recommendEmpty: 'Пока нет рекомендаций — задайте несколько вопросов',
      ...
      reasonRemedial: 'Разбор ошибок: здесь вы ошибались — попробуйте снова',
      reasonStruggling: 'Повторные переспросы: тема, вероятно, не усвоена — стоит потренироваться',
      ...
      changesIdle: 'без повторения {d} дн. · повторите скорее',
      ...
      kbdHint: 'A–D выбор · Enter отправить',
