<template>
 <section class="model-overview" aria-label="算法学习画像">
  <div class="model-heading"><div><span>自动学习画像</span><p><strong>{{ summary.covered }}</strong> / {{ summary.total }} 已接触</p></div><div class="model-key"><strong>{{ summary.counts.familiar }}</strong><span>检查支持</span></div></div>
