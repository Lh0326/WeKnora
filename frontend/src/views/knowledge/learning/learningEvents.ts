...
export function notifyLearningUpdated(kbId:string,slug:string,action?:'read'|'known'|'review') {
 window.dispatchEvent(new CustomEvent(LEARNING_UPDATED,{detail:{kbId,slug,action}}))
}
